...
$title = "Robust IT Training | File not Found!";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /file-not-found";
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">File not Found!</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="section section-padding-t90-b100">
        <div class="container shape-animate">
            ...
            <div class="section-title  mb-lg-12 mb-sm-8 mb-xs-8" data-aos="fade-up">
                <h2 class="title py-5">OOPS! PAGE NOT FOUND!</h2>
