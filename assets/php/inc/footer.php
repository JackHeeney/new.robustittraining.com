                ...
                <div class="footer-widget">
                    ...
                    <div class="footer-widget-content">
                        ...
                        <div class="footer-social-inline">
                            ...
                            <a href="<?php echo SITE_ADDR ?>/"><i class="fab fa-facebook-square"></i></a>
                            <a href="<?php echo SITE_ADDR ?>/"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Vendors JS -->
<!-- <script src="<?php echo SITE_ADDR ?>/assets/js/vendor/modernizr-3.6.0.min.js"></script>
<script src="<?php echo SITE_ADDR ?>/assets/js/vendor/jquery-3.6.0.min.js"></script>
<script src="<?php echo SITE_ADDR ?>/assets/js/vendor/jquery-migrate-3.3.2.min.js"></script>
<script src="<?php echo SITE_ADDR ?>/assets/js/vendor/bootstrap.bundle.min.js"></script> -->
<!-- TrustBox script -->
...
<!-- Plugins JS -->
<!-- 
        <script src="<?php echo SITE_ADDR ?>/assets/js/plugins/parallax.min.js"></script>
        <script src="<?php echo SITE_ADDR ?>/assets/js/plugins/jquery.ajaxchimp.min.js"></script>
        <script src="<?php echo SITE_ADDR ?>/assets/js/plugins/aos.min.js"></script>
        <script src="<?php echo SITE_ADDR ?>/assets/js/plugins/imagesloaded.pkgd.min.js"></script>
        <script src="<?php echo SITE_ADDR ?>/assets/js/plugins/isotope.pkgd.min.js"></script>
        <script src="<?php echo SITE_ADDR ?>/assets/js/plugins/jquery.animatedheadline.min.js"></script>
        <script src="<?php echo SITE_ADDR ?>/assets/js/plugins/jquery.counterup.min.js"></script>
        <script src="<?php echo SITE_ADDR ?>/assets/js/plugins/jquery.magnific-popup.min.js"></script>
        <script src="<?php echo SITE_ADDR ?>/assets/js/plugins/svg-inject.min.js"></script>
        <script src="<?php echo SITE_ADDR ?>/assets/js/plugins/swiper.min.js"></script>
        <script src="<?php echo SITE_ADDR ?>/assets/js/plugins/vanilla-tilt.min.js"></script>
        <script src="<?php echo SITE_ADDR ?>/assets/js/plugins/vidim.min.js"></script>
        <script src="<?php echo SITE_ADDR ?>/assets/js/plugins/vivus.min.js"></script>
        <script src="<?php echo SITE_ADDR ?>/assets/js/plugins/waypoints.min.js"></script>
...
<!-- Main Activation JS -->
<script src="<?php echo SITE_ADDR ?>/assets/js/main.js"></script>
