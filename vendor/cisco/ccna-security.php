...
$title = "Robust IT Training | CISCO | CCNA Security";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /cisco/ccna-security";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">CISCO CCNA Security</h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">CCNA Security</li>
                </ul>
            </div>
        </div>
    </div>
