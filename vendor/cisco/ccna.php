...
$title = "Robust IT Training | CISCO | CCNA";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /cisco/ccna";
                    ...
                    <div class="work-left work-details" data-aos="fade-up">
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-details-course-logo">
                                <img src="<?php echo SITE_ADDR ?>/assets/images/logo/cisco/cisco-ccna.png" alt="cloud practitioner logo" class="w-100">
                            </div>
                            <!-- Start Details List -->
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary" href="https://mkto.cisco.com/rs/564-WHV-323/images/Cisco-CCNA-Certification-Guide.pdf" target="_blank" alt="download CND exam guide">
