...
$title = "Robust IT Training | CISCO | CCNP Security";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /cisco/ccnp-security";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7" data-bg-image="<?php echo SITE_ADDR ?>/assets/images/bg/bg-ccna.jpg">
        <div class="page-title">
            <div class="container">
                <h1 class="title">CISCO CCNP Security</h1>
                <h4 class="sub-title text-white">Implementing and Operating Cisco Security Core Technologies</h4>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li><a href="<?php echo SITE_ADDR ?>/vendor/cisco">CISCO</a></li>
                    <li class="current">CCNP Security</li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="work-left work-details" data-aos="fade-up">
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-details-course-logo">
                                <img src="<?php echo SITE_ADDR ?>/assets/images/logo/cisco/cisco-ccnp.png" alt="cloud practitioner logo" class="w-100">
                            </div>
                            <!-- Start Details List -->
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary" href="https://www.cisco.com/c/dam/en_us/training-events/le3/docs/CCNP_Sec_Prog_Sol_Guide_18July2011.pdf" target="_blank" alt="download CND exam guide">
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <p>
                                            ...
                                            creating
                                            ever greater need for robust, scalable security across all platforms—from
                                            networks
                                            to mobile devices. With intent-based networking, security teams can take
                                            advantage
                                            of automation to scale their security solutions. To capitalize on these
                                            opportunities,
                                            today’s security professionals need a broader range of skills and deeper
                                            focus in
                                            strategic technology areas. The CCNP Security certification program gives
                                            you exactly
                                            that breadth and depth.
                                        </p>
                                        <p>
                                            We designed the CCNP Security certification to help you prove your skills in
                                            the
                                            ever-changing landscape of security technologies. The certification covers
                                            core
                                            technologies and a security focus area of your choice. You choose where you
                                            want to
                                        ...
                                        <p>
                                            ...
                                            CCNP
                                            sets you apart. It tells the world you know what you are doing. In addition,
                                            completing
                                            any CCNP certification exam earns you a Cisco&#174; Specialist
                                            certification, so
                                            you get
                                            recognized for your accomplishments along the way.
                                        </p>
                                    </div>
                                    <div class="content mb-12" data-aos="fade-up">
                                        <h6 class="title" data-aos="fade-up">What does it take to earn this
                                            certification?</h6>
                                        <p>
                                            To earn CCNP Security, you pass two exams: a core exam and a security
                                            concentration exam of your choice. And now every exam in the CCNP Security
                                            program earns an individual Specialist certification, so you get recognized
                                            for your accomplishments along the way.
                                        </p>
                                        <ul>
                                            <li>
                                                The core exam focuses on your knowledge of security infrastructure. The
                                                core exam is also the qualifying exam for CCIE Security certification.
                                                Passing the core exam will qualify candidates to schedule and take the
                                                CCIE lab within the validity of their core exam.
                                            </li>
                                            <li>
                                                Concentration exams focus on emerging and industry-specific topics. You
                                                can prepare for concentration exams by taking their corresponding Cisco
                                                training courses.
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="work-btn">
                                        <a class="btn btn-primary btn-hover-secondary" href="#beginnersModal" data-toggle="modal" data-target="#beginnersModal">Beginners start here
                        ...
                        <div class="col-xl-5 col-lg-6 col-12" data-aos="fade-up">
                            ...
                            <div class="skill-with-video-content">
                                ...
                                <div class="section-title-two mb-8">
                                    ...
                                    <span class="sub-title">How you'll benefit</span>
                                    <h2 class="title">
                                        Why use CCNP?
                                    </h2>
                                ...
                                <ul class="agency-list">
                                    <li class="item">
                                        ...
                                        <div class="text">
                                            Gain hands-on experience implementing core security technologies and learn
            ...
            <div class="text-white row my-lg-10 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff" data-bg-image="https://www.expatica.com/app/uploads/sites/10/2014/05/Find-a-job-1-1200x675.jpg" data-overlay="0.9">
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for CISCO CCNP
                            Professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            ...
                            <small>The average ccnp salary in the United Kingdom is £50,000 per year or £25.64 per hour.
                                Entry level positions start at £40,034 per year while most experienced workers make up
                                to £65,000 per year</small>.
                        </div>
                                ...
                                <div class="col-12 col-xl-6">
                                    ...
                                    <ul class="agency-list">
                                        ...
                                        <li class="item">
                                            ...
                                            <div class="text">
                                                IT Network Deployment Engineer
                                            </div>
                                        </li>
                                    </ul>
                                    <!-- job roles List End -->
                    ...
                    <div class="row my-lg-10 my-5">
                        ...
                        <div class="col-12 mt-5" data-aos="fade-up">
                            ...
                            <div class="faq-content">
                                <!-- Section Title Two Start -->
                                <div class="section-title-two">
                                    <span class="sub-title">Getting Certified</span>
                                    <h3 class="title">Earning your CCNP Security certification</h3>
                                </div>
                                <!-- Section Title Two End -->

                                <p>
                                    The CCNP Security certification program prepares you for today’s professional-level
                                    job roles in
                                    security technologies. One of the industry’s most respected certifications, CCNP
                                    validates the core
                                    knowledge you need while providing the flexibility to choose a focus area.
                                </p>
                                <p>
                                    To earn CCNP Security, you pass two exams: a core exam and a concentration exam of
                                    your choice.
                                </p>
                                ...
                                <div class="agency-accordion max-mb-n30" id="accordionExample">
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                            <div class="card-body">
                                                ...
                                                (350-701 SCOR), focuses on your knowledge of security infrastructure
                                                including network security, cloud security, content security, endpoint
                                                protection and detection, secure network access, visibility, and
                                                enforcements. You can prepare for this exam by taking the training
                                                course, Implementing and Operating Cisco Security Core Technologies
                                                (SCOR).
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                            <div class="card-body">
                                                Concentration exams focus on emerging and industry-specific topics such
                                                as Cisco Firepower,
                                                identity services, email security, web security, VPNs, and automation.
                                                You can prepare for concentration exams by taking corresponding Cisco
                                                training courses. Choose your CCNP Security concentration exam from
                                                these options:
                                                <ul>
                                                    <li>Securing Networks with Cisco Firepower (300-710 SNCF)</li>
                                                    <li>Implementing and Configuring Cisco Identity Services Engine
                                                        (300-715 SISE)</li>
                                                    <li>Securing Email with Cisco Email Security Appliance (300-720
                                                        SESA)</li>
                                                    <li>Securing the Web with Cisco Web Security Appliance (300-725
                                                        SWSA)</li>
                                                    <li>Implementing Secure Solutions with Virtual Private Networks
                                                        (300-730 SVPN)</li>
                                                    <li>Automating and Programming Cisco Security Solutions (300-735
                                                        SAUTO)</li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <p class="mt-10">
                                    The CCNP Security certification and training program provides real-world,
                                    job-focused skills in key
