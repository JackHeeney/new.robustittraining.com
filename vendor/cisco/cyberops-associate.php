...
$title = "Robust IT Training | CISCO | CyberOps Associate";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /cisco/cyberops-associate";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7" data-bg-image="<?php echo SITE_ADDR ?>/assets/images/bg/bg-ccna.jpg">
        <div class="page-title">
            <div class="container">
                <h1 class="title">CISCO CyberOps Associate</h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">CyberOps Associate</li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="work-left work-details" data-aos="fade-up">
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-details-course-logo">
                                <img src="<?php echo SITE_ADDR ?>/assets/images/logo/cisco/cisco-cyberops-associate.png" alt="cloud practitioner logo" class="w-100">
                            </div>
                            <!-- Start Details List -->
                            <div class="work-details-list my-10">
                                <div class="details-list">
                                    <label>Exam Prefix</label>
                                    <span>200-201 CBROPS</span>
                                </div>
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary" href="https://mkto.cisco.com/rs/564-WHV-323/images/Cyberops-Associate-Certification-Guide.pdf" target="_blank" alt="download CND exam guide">
                            ...
                            <div class="work-content">
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <p>
                                            Cisco Certified CyberOps Associate certification program validates the
                                            day-today, tactical knowledge and skills that Security Operations Center
                                            (SOC) teams need to detect and respond to cybersecurity threats.
                                        </p>
                                        <p>
                                            The CyberOps Associate exam and training cover knowledge and skills related
                                            to security concepts, security monitoring, hostbased analysis, network
                                    ...
                                    <div class="content mb-12" data-aos="fade-up">
                                        <h6 class="title" data-aos="fade-up">What does it take to earn this
                                            certification?</h6>
                                        <p>
                                            The Understanding Cisco Cybersecurity Operations Fundamentals (200-201
                                            CBROPS) exam is a 120-minute assessment that is associated with the Cisco
                                            Certified CyberOps Associate certification. The CBROPS exam tests a
                                            candidate’s knowledge and skills related to security concepts, security
                                            monitoring, host-based analysis, network intrusion analysis, and security
                                            policies and procedures. The course, Understanding Cisco Cybersecurity
                                            Operations Fundamentals, helps candidates to prepare for this exam.
                                        </p>
                                        <p>
