...
$title = "Robust IT Training | CISCO | CyberOps Professional";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /cisco/cyberops-professional";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7" data-bg-image="<?php echo SITE_ADDR ?>/assets/images/bg/bg-ccna.jpg">
        <div class="page-title">
            <div class="container">
                <h1 class="title">CISCO CyberOps Professional</h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">CyberOps Professional</li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="work-left work-details" data-aos="fade-up">
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-details-course-logo">
                                <img src="<?php echo SITE_ADDR ?>/assets/images/logo/cisco/cisco-cyberops-professional.png" alt="cloud practitioner logo" class="w-100">
                            </div>
                            <!-- Start Details List -->
                            <div class="work-details-list my-10">
                                ...
                                <div class="details-list">
                                    <label>Format</label>
                                    <span>
                                        110-120 questions; either multiple choice or multiple response
                                    </span>
                                </div>
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary" href="https://www.cisco.com/c/dam/en_us/training-events/certifications/professional/cyberops-professional-at-a-glance.pdf?dtid=osscdc000283" target="_blank" alt="download CND exam guide">
                            ...
                            <div class="work-content">
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <p>
                                            Traditional information security is no match for the expanding cybercrime
                                            ecosystem; therefore, security measures must evolve to intelligent security
                                            rather than information security. Achieving the Cisco Certified CyberOps
                                            Professional certification elevates your skills to meet that demand and
                                            confirms your abilities as an Information Security analyst in incident
                                            response roles, cloud security, and other active defense security roles.
                                        </p>
                                    </div>
                                    <div class="content mb-12" data-aos="fade-up">
                                        <h6 class="title" data-aos="fade-up">What does it take to earn this
                                            certification?</h6>
                                        <p>
                                            To earn Cisco Certified CyberOps Professional certification, you pass two
                                            exams: one that covers core technologies and one concentration exam. And
                                            every exam in the program earns an individual Specialist certification, so
                                            you get recognized for your accomplishments along the way.
                                        </p>
                                        <p>
                                            The core exam focuses on your knowledge of core cybersecurity operations
                                            including cybersecurity fundamentals, techniques, processes, and automation.
                                        </p>
                                        <p>
                                            The concentration exam focuses on incident response and digital forensics.
                                            Incident response is the process of detecting, responding to, and
                                            eradicating cyber-attacks. Digital forensics is the collection and
                                            examination of digital evidence residing on electronic devices and the
                                            subsequent response to threats and attacks.
                                        </p>
                                    </div>
            ...
            <div class="text-white row my-lg-10 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff" data-bg-image="https://www.expatica.com/app/uploads/sites/10/2014/05/Find-a-job-1-1200x675.jpg" data-overlay="0.9">
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for CISCO CyberOps Associate
                            Professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            ...
                            <small>The average CyberOps salary in the United Kingdom is £50,000 per year or
                                £25.64 per hour. Entry level positions start at £40,000 per year while most experienced
                                workers make up to £57,500 per year
                            </small>.
                        </div>
                                ...
                                <div class="col-12 col-xl-6">
                                    ...
                                    <ul class="agency-list">
                                        ...
                                        <li class="item">
                                            ...
                                            <div class="text">
                                                Associate Consultant-Cyber Risk Advisory
                                            </div>
                                        </li>
                                        <li class="item">
                                            <div class="icon">
                        ...
                        <div class="col-12 mt-5" data-aos="fade-up">
                            ...
                            <div class="faq-content">
                                ...
                                <div class="section-title-two">
                                    ...
                                    <h3 class="title">Start your CyberOps journey</h3>
                                </div>
                                <!-- Section Title Two End -->
                                ...
                                <div class="agency-accordion max-mb-n30" id="accordionExample">
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                                            <div class="card-body">
                                                ...
                                                webinars and the CyberOps community, where you can ask technical
                                                questions, join discussions, and receive study tips to help you achieve
                                                your CyberOps Associate certification.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample">
                                            <div class="card-body">
                                                Test your readiness with official CyberOps Associate practice questions.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionExample">
                                            <div class="card-body">
                                                Schedule to take your CyberOps Associate exam online or at a Pearson VUE
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingEight">
                                            <h5 class="mb-0">
                                                <a href="#" class="acc-btn border-0 collapsed" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                                                    Step 8: Recertify
                                                </a>
                                            </h5>
                                        </div>
