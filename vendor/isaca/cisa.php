                    ...
                    <div class="work-left work-details" data-aos="fade-up">
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-details-course-logo">
                                <img src="<?php echo SITE_ADDR ?>/assets/images/logo/isaca/cisa.png" alt="CISA logo"
                                    class="w-100">
                            </div>
                            <!-- Start Details List -->
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/isaca/cisa/Exam-Candidate-Guide-English_0621.pdf"
                                    target="_blank" alt="download CISA exam guide">
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a class="btn btn-outline-secondary btn-hover--secondary my-5"
                                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/isaca/cisa/CISAplanningguide_2019.pdf"
                                                    target="_blank" alt="download CISA exam guide">
