...
$title = "Robust IT Training | CompTIA | Server+";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /comptia/comptia-server";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7" data-bg-image="<?php echo SITE_ADDR ?>/assets/images/bg/bg-certified-ethical-hacker.jpg">
        <div class="page-title">
            <div class="container">
                <h1 class="title">CompTIA Server+</h1>
                    ...
                    <div class="work-left work-details" data-aos="fade-up">
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-details-course-logo">
                                <img src="<?php echo SITE_ADDR ?>/assets/images/logo/comptia/logoserverplus.svg" alt="CompTIA Network+ logo" class="w-100">
                            </div>
                            <!-- Start Details List -->
                            <div class="work-details-list my-10">
                                <div class="details-list">
                                    <label>Exam Prefix</label>
                                    <span>SK0-004 & SK0-005</span>
                                </div>
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary" href="https://comptiacdn.azureedge.net/webcontent/docs/default-source/booksamples/server_sk0-005_samplelesson.pdf?sfvrsn=9ba1b161_2" target="_blank" alt="download A+ exam guide">
                            ...
                            <div class="work-content">
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <p>
                                            CompTIA Server+ ensures pros have the skills to work in data centers or
                                            cloud environments.
                                        </p>
                                        <p>
                                            CompTIA Server+ is a global certification that validates the hands-on skills
                                            of IT professionals who install, manage and troubleshoot servers in data
                                            centers as well as on-premise and hybrid environments.
                                        </p>
                                        <P>
                                            CompTIA Server+ is the only certification that can ensure that IT
                                            professionals at the administrator level are able to do the job in any
                                            environment because it is the only certification not restricted to a single
                                            platform. The exam covers essential hardware and software technologies of
                                            on-premise and hybrid server environments including high availability, cloud
                                            computing and scripting. The new exam includes performance-based questions
                                            that require the candidate to demonstrate multi-step knowledge to securely
                                            deploy, administer and troubleshoot servers.
                                        </P>
                                        <P>
                                            CompTIA Server+ now features flexible training options including self-paced
                                        ...
                                        <strong>
                                            The new CompTIA Server+ SK0-005 is now available. CompTIA Server+ SK0-004
                                            (English language version) will retire January 7, 2022.
                                        </strong>

                                    </div>
                                    <div class="content mb-5" data-aos="fade-up">
                                        <h6 class="title" data-aos="fade-up">Why is CompTIA Server+ different?
                                        </h6>

                                        <p>
                                            12% job growth is expected for Network & Computer Systems Administrators,
                                            2012 – 2022, according to the latest BLS website information.
                                        </p>
                                        <ul>
                                            <li>
                                                Average salary for a Server+ certified IT professionals is about
                                                $82,000.*
                                            </li>
                                            <li>
                                                82% of employers recognize that certified employees are valuable to
                                                their organizations.**
                                            </li>
                                        </ul>
                                    </div>
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff" data-bg-image="<?php echo SITE_ADDR ?>/assets/images/banner/job-rolls.jpg" data-overlay="0.9">
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            <h2 class="title mb-5">
                                <div class="salary text-white">£<span class="counter">42,820.00</span>+</div>
                            </h2>
                            <small>The average server+ salary in the United Kingdom is £42,820 per year or £21.96 per
                                hour. Entry level positions start at £32,460 per year while most experienced workers
                                make up to £60,000 per year</small>.
                        </div>
