        ...
        <div class="container">
            ...
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 mb-n6">
                ...
                <div class="col mb-6">
                    <div class="work">
                        <div class="thumbnail">
                            <a class="image" href="<? echo SITE_ADDR ?>/vendor/comptia/comptia-it-fundamentals"><img
                ...
                <div class="col mb-6">
                    <div class="work">
                        <div class="thumbnail">
                            <a class="image" href="<? echo SITE_ADDR ?>/vendor/comptia/comptia-a"><img
                ...
                <div class="col mb-6">
                    <div class="work">
                        <div class="thumbnail">
                            <a class="image" href="<? echo SITE_ADDR ?>/vendor/comptia/comptia-network"><img
                ...
                <div class="col mb-6">
                    <div class="work">
                        <div class="thumbnail">
                            <a class="image" href="<? echo SITE_ADDR ?>/vendor/comptia/comptia-security"><img
                                    src="<? echo SITE_ADDR ?>/assets/images/project/project-4.jpg" alt="work"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<? echo SITE_ADDR ?>/vendor/comptia/comptia-security">Security+</a>
                            </h3>
                            <p class="desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda esse
                                culpa, unde perspiciatis hic delectus.</p>
                ...
                <div class="col mb-6">
                    <div class="work">
                        <div class="thumbnail">
                            <a class="image" href="<? echo SITE_ADDR ?>/vendor/comptia/comptia-server"><img
                ...
                <div class="col mb-6">
                    <div class="work">
                        <div class="thumbnail">
                            <a class="image" href="<? echo SITE_ADDR ?>/vendor/comptia/comptia-linux"><img
                ...
                <div class="col mb-6">
                    <div class="work">
                        <div class="thumbnail">
                            <a class="image" href="<? echo SITE_ADDR ?>/vendor/comptia/comptia-pentest"><img
                                    src="<? echo SITE_ADDR ?>/assets/images/project/project-1.jpg" alt="work"></a>
                        </div>
                        <div class="info">
                ...
                <div class="col mb-6">
                    <div class="work">
                        <div class="thumbnail">
                            <a class="image" href="<? echo SITE_ADDR ?>/vendor/comptia/comptia-cysa"><img
                                    src="<? echo SITE_ADDR ?>/assets/images/project/project-2.jpg" alt="work"></a>
                        </div>
                        <div class="info">
                ...
                <div class="col mb-6">
                    <div class="work">
                        <div class="thumbnail">
                            <a class="image" href="<? echo SITE_ADDR ?>/vendor/comptia/comptia-casp"><img
                                    src="<? echo SITE_ADDR ?>/assets/images/project/project-3.jpg" alt="work"></a>
                        </div>
                        <div class="info">
                ...
                <div class="col mb-6">
                    <div class="work">
                        <div class="thumbnail">
                            <a class="image" href="<? echo SITE_ADDR ?>/vendor/comptia/comptia-cloud"><img
                                    src="<? echo SITE_ADDR ?>/assets/images/project/project-4.jpg" alt="work"></a>
                        </div>
                        <div class="info">
