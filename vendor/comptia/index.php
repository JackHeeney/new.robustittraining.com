            ...
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 mb-n6">
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/comptia/comptia-it-fundamentals"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/comptia/itf-plus.jpg"
                                    alt="itf-plus.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/comptia/comptia-a"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/comptia/a-plus.jpg"
                                    alt="a-plus.jpg"></a>
                        </div>
                        <div class="info">
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/comptia/comptia-network"><img
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/comptia/comptia-security"><img
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/comptia/comptia-server"><img
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/comptia/comptia-linux"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/comptia/linux-plus.jpg"
                                    alt="linux-plus.jpg"></a>
                        </div>
                        <div class="info">
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/comptia/comptia-pentest"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/comptia/pentest-plus.jpg"
                                    alt="pentest-plus.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/comptia/comptia-cysa"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/comptia/cysa-plus.jpg"
                                    alt="cysa-plus.jpg"></a>
                        </div>
                        <div class="info">
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/comptia/comptia-casp"><img
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/comptia/comptia-cloud"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/comptia/cloud-plus.jpg"
                                    alt="cloud-plus.jpg"></a>
                        </div>
                        <div class="info">
