...
$title = "Robust IT Training | AWS | Solutions Architect Associate ";
$meta['keywords'] = "Amazon Web Services, AWS, Cloud";
$meta['description'] = "Robust IT Training AWS Solutions Architect Associate course.";

// Social media meta tags
$title = "Robust IT Training | AWS | Solutions Architect Associate";
$meta['og:description'] = "Robust IT Training AWS Solutions Architect Associate course.";
$meta['og:image'] = "";
$meta['og:url'] = "";

$leadIsFrom = "Lead is from /vendor/aws/aws-solutions-architect-associate";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7" data-bg-image="<?php echo SITE_ADDR ?>/assets/images/hero-image/hero-aws-cloud-practitioner.jpeg">
        <div class="page-title">
            <div class="container">
                <h1 class="title">AWS Solutions Architect Associate</h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">Solutions Architect Associate</li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="work-left work-details" data-aos="fade-up">
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-details-course-logo">
                                <img src="<?php echo SITE_ADDR ?>/assets/images/logo/aws/AWS-Soluitons-Architect-Assoc.png" alt="cloud practitioner logo" class="w-100">
                            </div>
                            <!-- Start Details List -->
                            <div class="work-details-list my-10">
                                ...
                                <div class="details-list">
                                    <label>Length</label>
                                    <span>130 minutes to complete the exam</span>
                                </div>
                            ...
                            <div class="work-content">
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <p class="text-danger">
                                            The AWS Certified Solutions Architect - Associate certification exam is
                                            changing August 30, 2022. The last date to take the current exam is August
                                            29, 2022. <a class="text-primary" href="https://aws.amazon.com/certification/coming-soon/" target="_blank" alt="link to new aws certification">learn more</a>.
                                        </p>
                                        <p>
                                            ...
                                            Solutions Architect – Associate validates the ability to design and
                                            implement distributed systems on AWS.
                                        </p>
                                    </div>
                                    ...
                                    <div class="content mb-5" data-aos="fade-up">
                                        ...
                                        <p>
                                            ...
                                            one or more years of hands-on experience designing available,
                                            cost-efficient, fault-tolerant, and scalable distributed systems on AWS.
                                            Before you take this exam, we recommend you have:
                                        </p>
                                        <ul>
                                            <li>
                                                One year of hands-on experience with AWS technology, including using
                                                compute, networking, storage, and database AWS services as well as AWS
                                                deployment and management services
                                            </li>
                                            <li>
                                                Experience deploying, managing, and operating workloads on AWS as well
                                                as implementing security controls and compliance requirements
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                Understanding of the AWS Well-Architected Framework, AWS networking,
                                    ...
                                    <div class="content mb-5" data-aos="fade-up">
                                        ...
                                        <p>
                                            ...
                                            Solutions Architect – Associate exam (SAA-C02). The exam features a
                                            combination of two question formats: multiple choice and multiple response.
                                            Additional information, such as the exam content outline and passing score,
                                            is in the exam guide.
                                        </p>
                                    </div>
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff" data-bg-image="https://www.expatica.com/app/uploads/sites/10/2014/05/Find-a-job-1-1200x675.jpg" data-overlay="0.9">
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            <h2 class="title mb-5">
                                <div class="salary text-white">£<span class="counter">76,250.00</span>+</div>
                            </h2>
