...
$title = "Robust IT Training | AWS | Cloud Practitioner ";
$meta['keywords'] = "Amazon Web Services, AWS, Cloud";
$meta['description'] = "Robust IT Training AWS | Cloud Practitioner course.";

// Social media meta tags
$title = "Robust IT Training | AWS | Cloud Practitioner";
$meta['og:description'] = "Robust IT Training AWS | Cloud Practitioner course.";
$meta['og:image'] = "";
$meta['og:url'] = "";
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">AWS Cloud Practitioner</li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="work-left work-details" data-aos="fade-up">
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-details-course-logo">
                                <img src="<?php echo SITE_ADDR ?>/assets/images/logo/aws/AWS-CloudPractitioner.png"
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    ...
                                    target="_blank" alt="download aws cloud practitioner exam guide">
