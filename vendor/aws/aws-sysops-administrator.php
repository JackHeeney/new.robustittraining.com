...
$title = "Robust IT Training | AWS | SysOps Administrator ";
$meta['keywords'] = "Amazon Web Services, AWS, Cloud, SysOps, Administrator";
$meta['description'] = "Robust IT Training AWS SysOps Administrator course.";

// Social media meta tags
$title = "Robust IT Training | AWS | SysOps Administrator";
$meta['og:description'] = "Robust IT Training AWS SysOps Administrator course.";
$meta['og:image'] = "";
$meta['og:url'] = "";
                    ...
                    <div class="work-left work-details" data-aos="fade-up">
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-details-course-logo">
                                <img src="<?php echo SITE_ADDR ?>/assets/images/logo/aws/AWS-SysOps-Administrator.png" alt="cloud practitioner logo" class="w-100">
                            </div>
                            <!-- Start Details List -->
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary" href="https://d1.awsstatic.com/training-and-certification/docs-sysops-associate/AWS-Certified-SysOps-Administrator-Associate_Exam-Guide.pdf" target="_blank" alt="download aws sysops administrator exam guide">
