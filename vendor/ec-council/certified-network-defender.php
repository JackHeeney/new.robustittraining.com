                    ...
                    <div class="work-left work-details" data-aos="fade-up">
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-details-course-logo">
                                <img src="<?php echo SITE_ADDR ?>/assets/images/logo/ec-council/cnd.png" alt="cloud practitioner logo" class="w-100">
                            </div>
                            <!-- Start Details List -->
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary" href="https://d1.awsstatic.com/training-and-certification/docs-sa-assoc/AWS-Certified-Solutions-Architect-Associate_Exam-Guide.pdf" target="_blank" alt="download CND exam guide">
                        ...
                        <div class="work-main-info">
                            <div class="work-content">
                                ...
                                <div class="desc mt-8">
                                    ...
                                    <div class="content mb-5" data-aos="fade-up">
                                        <h6 class="title" data-aos="fade-up">Who Should Get Trained in Network Security?
                                        </h6>
                                        <p>
                    ...
                    <div class="row align-items-center my-lg-20 my-12">
                        ...
                        <div class="col-xl-5 col-lg-6 col-12" data-aos="fade-up">
                            ...
                            <div class="skill-with-video-content">
                                ...
                                <div class="section-title-two mb-4">

                                    <span class="sub-title">How You Will Benefit from CND v2</span>
                                ...
                                <ul class="agency-list">
                                    <li class="item">
                                        ...
                                        <div class="text">
                                            Based on Common Job Role frameworks recognized by organizations around the
                                            world.
                                        </div>
                                    </li>
                                    <li class="item">
                                    ...
                                    <li class="item">
                                        ...
                                        <div class="text">
                                            Focuses on latest technologies including Cloud, IoT, Virtualization and
                                            Remote Worker Threats, Attack Surface Analysis, Threat Intelligence,
                                            Software Defined Networks (SDN), and Network Function Virtualization (NFV),
                                            as well as docker, Kubernetes, and container security.
                                    ...
                                    <li class="item">
                                        ...
                                        <div class="text">
                                            Covers the latest tools, techniques, and methodologies used by top
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            <h2 class="title mb-5">
                                <div class="salary text-white">£<span class="counter">51,450.00</span>+</div>
                            </h2>
                    ...
                    <div class="row my-lg-14 my-7">
                        ...
                        <div class="col-12 mt-lg-1 mt-20" data-aos="fade-up">
                            ...
                            <div class="faq-content">
                                <!-- Section Title Two Start -->
                                <div class="section-title-two">
                                    <span class="sub-title">Career with CND</span>
                                    <h3 class="title">How CND v2 Will Build Your Career</h3>
                                </div>
                                <!-- Section Title Two End -->
                                ...
                                <div class="agency-accordion max-mb-n30" id="accordionExample">
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                            <div class="card-body">
                                                The <strong>Protect, Detect, Respond, and Predict</strong> approach
                                                defines the job roles
                                                for a Blue Team Security Professional. One can continue their career as
                                                a Network Defender or later transition into a niche job profile as CND
                                                v2 covers a base understanding of Blue Teams.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                            <div class="card-body">
                                                The first certification program to offer device and enterprise level
                                                security for its students. Career changers planning a move into
                                                cybersecurity will also benefit from this.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                                            <div class="card-body">
                                                Learn different ways to ensure security across various cloud platforms —
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                                            <div class="card-body">
                                                CND v2 is the only certification program that offers a chance to learn
                                                beyond the technological aspects of network security. The module has a
                                                strong focus on the strategical domain with special attention to
                                                adaptive & defense in depth security, framing network policies,
                                                achieving compliance, and the operational domain to learn the
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample">
                                            <div class="card-body">
                                                CND v2 puts the spotlight on perimeter defense as the latest
                                                technologies have made networks too complex for everyone. Perimeter
                                                defense can help with modern security requirements.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample">
                                            <div class="card-body">
                                                The only program that gives a chance to students to learn under
                                                simulated threat environments and gain real-world skills before they
