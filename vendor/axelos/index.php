            ...
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 mb-n6">
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/axelos/itil" alt="ITIL"><img
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/axelos/prince2" alt="prince2"><img
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/axelos/prince2-agile"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/axelos/prince2-agile/prince2-agile.jpg"
                                    alt="prince2-agile.jpg"></a>
                        </div>
                        <div class="info">
