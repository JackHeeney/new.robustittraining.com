            ...
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 mb-n6">
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/axelos/itil"><img src="<?php echo SITE_ADDR ?>/assets/images/bg/bg-project-manager.jpg" alt="work"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a href="<?php echo SITE_ADDR ?>/vendor/axelos/itil">ITIL &#174;</a></h3>
                            ...
                            <a href="<?php echo SITE_ADDR ?>/vendor/axelos/itil">View Course
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/axelos/prince2"><img src="<?php echo SITE_ADDR ?>/assets/images/bg/bg-project-manager.jpg" alt="work"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a href="<?php echo SITE_ADDR ?>/vendor/axelos/prince2">PRINCE2 &#174;</a>
                            </h3>
                            <p class="desc">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sed nisi, quo
                                optio sint doloribus repellat.</p>
                            <a href="<?php echo SITE_ADDR ?>/vendor/axelos/prince2">View Course <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                </div>
                <!-- Single Work End -->
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/axelos/prince2-agile"><img src="<?php echo SITE_ADDR ?>/assets/images/bg/bg-project-manager.jpg" alt="work"></a>
                        </div>
                        <div class="info">
                            ...
                            <p class="desc">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sed nisi, quo
                                optio sint doloribus repellat.</p>
                            <a href="<?php echo SITE_ADDR ?>/vendor/axelos/prince2-agile">View Course <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                </div>
                <!-- Single Work End -->
