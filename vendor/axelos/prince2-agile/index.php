            ...
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 mb-n6">
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image"
                                href="<?php echo SITE_ADDR ?>/vendor/axelos/prince2-agile/prince2-agile-foundation"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/axelos/prince2-agile/prince2-agile.jpg"
                                    alt="work"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<?php echo SITE_ADDR ?>/vendor/axelos/prince2-agile/prince2-agile-foundation">PRINCE2&#174;
                                    Agile
                                    Foundation</a></h3>
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image"
                                href="<?php echo SITE_ADDR ?>/vendor/axelos/prince2-agile/prince2-agile-practitioner"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/axelos/prince2-agile/prince2-agile.jpg"
                                    alt="work"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<?php echo SITE_ADDR ?>/vendor/axelos/prince2-agile/prince2-agile-practitioner">PRINCE2&#174;
                                    Agile
                                    Practitioner</a></h3>
                            <p class="desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Saepe, quaerat
                                quisquam? Laborum, pariatur delectus reiciendis quod quasi ullam labore perferendis
