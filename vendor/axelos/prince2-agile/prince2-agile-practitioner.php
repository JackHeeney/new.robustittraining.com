        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li><a href="<?php echo SITE_ADDR ?>/vendor/axelos/prince2-agile">PRINCE2&#174; Agile</a></li>
                    ...
                    <div class="work-left work-details" data-aos="fade-up">
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-details-course-logo">
                                <img src="<?php echo SITE_ADDR ?>/assets/images/logo/axelos/prince2/prince2-agile-logo.png" alt="cloud practitioner logo" class="w-100">
                            </div>
                            <!-- Start Details List -->
                            <div class="work-details-list my-10">
                                ...
                                <div class="details-list">
                                    <label>Format</label>
                                    <span>
                                        50 questions each worth one mark<br>
                            ...
                            <div class="details-list mb-10">
                                <label>Extra</label>
                                <span>
                                    <strong>Due to the impact of the coronavirus, from 13 April 2020 to 31 December 2021
                                        individuals are now permitted to print PDFs for exams and use PDFs or official
                                        e-books on a second e-device (portable digital devices such as smartphones,
                                        tablets and laptops) during open book exams.</strong>
                                </span>
                            </div>
                            <!-- End Details List -->

                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary" href="https://eu-assets.contentstack.com/v3/assets/blt637b065823946b12/blt69bc2b6935057c59/617691fb8e52444950792030/PRINCE2-Agile-Foundation-Candidate-Syllabus.pdf" target="_blank" alt="download CND exam guide">
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <p>
                                            ...
                                            toolset of agile delivery techniques and frameworks. The PRINCE2 Agile
                                            Practitioner teaches you to blend structure, governance and control with
                                            agile methods, techniques and approaches. Practitioner takes the knowledge
                                            acquired at Foundation level and applies it to the workplace, using
                                    ...
                                    <div class="content mb-10" data-aos="fade-up">
                                        ...
                                        <ul>
                                            <li>
                                                PRINCE2 Agile Practitioner is aimed at professionals who work within a
                                                project environment, including key staff involved with integrating
                                                project management with product delivery.
                                            </li>
                                            <li>
                                                An understanding of the agile concepts detailed in PRINCE2 Agile will
                                                also be beneficial to those with governance responsibilities for
                                                projects using agile delivery approaches as well as those involved with
                                                programme and project support functions.
                                            </li>
                                            <li>
                                                It is a must-have certification for both project managers and
                                                non-project management professionals to deliver value to their employers
                                    ...
                                    <div class="content mb-10" data-aos="fade-up">
                                        ...
                                        <p>
                                            To take the <a class="text-primary" href="<?php echo SITE_ADDR ?>/vendor/axelos/prince2-agile/prince2-agile-foundation" alt="link to PRINCE2 Agile foundation" target="_blank">PRINCE2 Agile
                                                Practitioner</a> examination, you must hold PRINCE2
                                            Agile Foundation or any PRINCE2 certification.
                                        </p>
                                        <p>
                                            Other accepted certificates are: Project Management Professional® (PMP),
                                            Certified Associate in Project Management® (CAPM), IMPA Levels A, B, C and
                                            D®(Certified Projects Director).
                                        </p>
                                        <p>
                                            PRINCE2 Agile Practitioner certificates are valid for 3 years. To remain
                                            accredited, Practitioners can re-sit the exam, or log CPD points through our
                                            online subscription, My PRINCE2.
                                        </p>
                        ...
                        <div class="col-xl-5 col-lg-6 col-12" data-aos="fade-up">
                            ...
                            <div class="skill-with-video-content">
                                ...
                                <div class="section-title-two mb-8">
                                    ...
                                    <span class="sub-title">Reasons why to take the PRINCE2 Agile Practitioner</span>
                                    <h2 class="title">
                                        Why use PRINCE2?
                                    </h2>
                                </div>
            ...
            <div class="text-white row my-lg-10 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff" data-bg-image="https://www.expatica.com/app/uploads/sites/10/2014/05/Find-a-job-1-1200x675.jpg" data-overlay="0.9">
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for PRINCE2 Agile Professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            ...
                            <small>
                                The average prince2 agile salary in the United Kingdom is £50,000 per year or £25.64 per
                                hour. Entry level positions start at £38,500 per year while most experienced workers
                                make up to £65,000 per year
                            </small>.
                        </div>
