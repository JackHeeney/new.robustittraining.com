...
$title = "Robust IT Training | Axelos | PRINCE2 Agile | PRINCE2 Agile Foundation";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /axelos/prince2-agile/prince2-agile-foundation";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7" data-bg-image="<?php echo SITE_ADDR ?>/assets/images/bg/bg-project-manager.jpg">
        <div class="page-title">
            <div class="container">
                <h1 class="title">PRINCE2&#174; Agile Foundation</h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">PRINCE2&#174; Agile Foundation</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-details-list my-10">
                                ...
                                <div class="details-list">
                                    <label>Format</label>
                                    <span>
                                        50 Questions, Multiple Choice<br>
                                        Pass mark of 55%
                                    </span>
                                </div>
                            </div>
                            <div class="details-list mb-10">
                                <label>Extra</label>
                                <span>
                                    The PRINCE2 Agile Foundation examinations are currently available in English,
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary" href="https://eu-assets.contentstack.com/v3/assets/blt637b065823946b12/blt46c7d19be357b597/617691fbc8a5784a94380ef5/PRINCE2-Agile-Practitioner-Candidate-Syllabus.pdf" target="_blank" alt="download CND exam guide">
                            ...
                            <div class="work-content">
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        ...
                                        <p>
                                            PRINCE2 Agile Foundation is also a pre-requisite for the <a class="text-primary" href="<?php echo SITE_ADDR ?>/vendor/axelos/prince2-agile/prince2-agile-practitioner" alt="link to PRINCE2 Agile Practitioner" target="_blank">Practitioner
                                                certification</a>.
                                        </p>
                                    </div>
                                    ...
                                    <div class="content mb-10" data-aos="fade-up">
                                        ...
                                        <p>
                                            ...
                                            anyone working within an agile project environment, whether they're a
                                            project manager, project support or part of the wider project team.
                                        </p>
                        ...
                        <div class="col-xl-5 col-lg-6 col-12" data-aos="fade-up">
                            ...
                            <div class="skill-with-video-content">
                                ...
                                <div class="section-title-two mb-8">
                                    ...
                                    <span class="sub-title">Reasons why to take the PRINCE2 Agile Foundation</span>
                                    <h2 class="title">
                                        Why use PRINCE2?
                                    </h2>
                                </div>
