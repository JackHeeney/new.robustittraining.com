...
$title = "Robust IT Training | Axelos | PRINCE2 | PRINCE2 4 Foundation";
$meta['keywords'] = "";
$meta['description'] = "";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7" data-bg-image="<?php echo SITE_ADDR ?>/assets/images/bg/bg-project-manager.jpg">
        <div class="page-title">
            <div class="container">
                <h1 class="title">PRINCE2&#174; 4 Foundation</h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">PRINCE2&#174; 4 Foundation</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-details-list my-10">
                                ...
                                <div class="details-list">
                                    <label>Format</label>
                                    <span>
                                        60 questions, multiple choice <br>
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary" href="https://eu-assets.contentstack.com/v3/assets/blt637b065823946b12/blted99974a8a3bd024/61717c2db2d0f04952831b52/PRINCE2-2017-Foundation-Syllabus.pdf" target="_blank" alt="download PRINCE2 4 Foundation exam guide">
                            ...
                            <div class="work-content">
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <p>
                                            The Foundation Level certification introduces the PRINCE2 method and aims to
                                            confirm that you know and understand the PRINCE2 method well enough to be
                                            able to work effectively with, or as a member of, a project management team
                                            working within an environment supporting PRINCE2. The Foundation
                                            certification is also a pre-requisite for the Practitioner certification.
                                        </p>
                                        <p>
                                            Typically, classroom training for PRINCE2 Foundation lasts two and a half
                                            days and the examination takes place at the end of the training (this will
                                            vary depending on the training provider). You can also self-study for the
                                            Foundation exam and you may also choose to take training in another format
                                            such as distance learning. Training is delivered by Axelos' Accredited
                                            Training Organizations (ATOs) who set their own rates.
                                        </p>
                                        <p>
                                    ...
                                    <div class="content mb-10" data-aos="fade-up">
                                        <h6 class="title" data-aos="fade-up">Who should do this course?
                                        </h6>

                                        <p>
                                            This certification is aimed at current and aspiring project managers or
                                            professionals who manage projects. It is also relevant to other key staff
