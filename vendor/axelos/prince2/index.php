...
$title = "Robust IT Training | Axelos | PRINCE2 Certifications";
$meta['keywords'] = "";
$meta['description'] = "";

// Social media meta tags
$meta['og:title'] = "Robust IT Training | Axelos | PRINCE2 Certifications";
$meta['og:description'] = "";
$meta['og:image'] = "";
$meta['og:url'] = "";

$leadIsFrom = "Lead is from /axelos/prince2";
...
<div id="page" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7" data-bg-image="<?php echo SITE_ADDR ?>/assets/images/bg/breadcrumb-bg-two.jpg">
        <div class="page-title">
            <div class="container">
                <h1 class="title">PRINCE2&#174; Certifications</h1>
            </div>
        </div>
    ...
    <div class="section section-padding-t90-b100">
        <div class="container">
            ...
            <div class="section-title text-center " data-aos="fade-up">
                <h2 class="title fz-32">PRINCE2&#174; Certifications :</h2>
                <p>Explore PRINCE2&#174; certifications most sought after by employers</p>
            </div>
            <!-- Section Title End -->
            ...
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 mb-n6">
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/axelos/prince2/prince2-4-foundation"><img src="<?php echo SITE_ADDR ?>/assets/images/bg/bg-project-manager.jpg" alt="work"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a href="<?php echo SITE_ADDR ?>/vendor/axelos/prince2/prince2-4-foundation">PRINCE2&#174;
                                    4
                                    Foundation</a></h3>
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/axelos/prince2/prince2-4-practitioner"><img src="<?php echo SITE_ADDR ?>/assets/images/bg/bg-project-manager.jpg" alt="work"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a href="<?php echo SITE_ADDR ?>/vendor/axelos/prince2/prince2-4-practitioner">PRINCE2&#174;
                                    4
                                    Practitioner</a></h3>
                            <p class="desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Saepe, quaerat
                                quisquam? Laborum, pariatur delectus reiciendis quod quasi ullam labore perferendis
