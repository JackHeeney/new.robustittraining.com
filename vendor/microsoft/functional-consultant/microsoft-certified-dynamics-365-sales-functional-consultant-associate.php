            ...
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li><a href="<?php echo SITE_ADDR ?>/vendor/microsoft/functional-consultant">Functional
                            Consultant</a></li>
                    <li class="current">Microsoft Certified: Dynamics 365: Sales Functional Consultant Associate
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                ...
                                <a class="btn btn-outline-secondary btn-hover--secondary mt-5"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-mb-210-microsoft-dynamics-365-sales-functional-consultant-skills-measured.pdf"
                                    target="_blank" alt="download MB-210 exam guide">
                                    Download the MB-210 guide
                                    <i class="fas fa-download fcr-animate"></i>
                                </a>
                            </div>
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <div class="alert alert-primary">
                                            ...
                                            Exam MB-210 was updated on July 23, 2021, and Exam PL-200 was updated on
                                            October 1, 2021. Please download the skills measured documents on the
                                            associated exam pages to see changes.
                                        </div>
                                        <p>
                                            If you’re a functional consultant, a professional working with Microsoft
                                            Dynamics 365 Sales, or a developer looking to hone your consulting skills,
                                            this certification could help give your career a boost. It lets you market
                                            yourself more effectively for projects and shows your organization that you
                                            can use Dynamics 365 Sales to empower the sales force.
                                        </p>
                                        <p>
                                            As a candidate for this certification, you have experience configuring
                                            Microsoft Power Platform and you know Dynamics 365 model-driven applications
                                            and data-modeling principles. You work with an organization’s stakeholders
                                            to gather requirements and implement Dynamics 365 Sales solutions. You
                                            manage leads, opportunities, quotes, and orders, and you configure product
                                            catalogs and price lists. Additionally, you configure Dynamics 365 Sales to
                                            match your organization's unique business process, and you model Dynamics
                                            365 Sales data. You even extend Dynamics 365 solutions using Power Platform
                                            components, such as Power Automate and Power Apps.
                                        </p>
                                        <p>
                                        ...
                                        <ul>
                                            ...
                                            <li>ShaShadow a functional consultant or a solution architect who works with
                                                Dynamics 365 Sales</li>
                    ...
                    <div class="row align-items-center my-lg-20 my-12">
                        ...
                        <div class="col-xl-5 col-lg-6 col-12" data-aos="fade-up">
                            ...
                            <div class="skill-with-video-content">
                                ...
                                <!-- Agency List End -->
                                <a href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/microsoft-certified-dynamics-365-sales-functional-consultant-associate-skills-measured.pdf"
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for Sales Functional Consultant
                            professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            ...
                            <small>The average sales functional consultant salary in the United Kingdom is £65,000 per
                                year or £33.33 per hour. Entry level positions start at £57,500 per year while most
                                experienced workers make up to £80,625 per year</small>.
                        </div>
                                        ...
                                        <div class="card-header" id="headingTwo">
                                            <h5 class="mb-0">
                                                <a href="#" class="acc-btn border-0" data-toggle="collapse"
                                                    ...
                                                    Exam MB-210: Microsoft Dynamics 365 Sales Functional Consultant
                                                </a>
                                            </h5>
                                        </div>
                                        ...
                                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                            ...
                                            <div class="card-body">
                                                <div class="alert alert-primary">
                                                    <i class="fa fa-info-circle pr-1"></i> <strong>Important</strong>
                                                    <br />
                                                    The English language version of this exam was updated on July 23,
                                                ...
                                                <p>
                                                    ...
                                                    consultants with sales expertise. Candidates are responsible for
                                                    implementing solutions that support a sales life cycle so that it
                                                    can run efficiently and effectively to meet revenue targets,
                                                    business strategies, and company objectives.
                                                </p>
                                                <p>
                                                    Candidates are responsible for configuring and expanding the core
                                                    functionality of leads, contacts, accounts, opportunities, and
                                                    supporting entities to map to the sales processes in place at the
                                                    organization. They identify opportunities to use Power Apps to
                                                    develop unified experiences for all devices, Power Automate for
                                                    application integration, business process flows, and other
                                                    automation tools to construct an application that supports and
                                                    accelerates the “lead to cash” journey.
                                                </p>
                                                <p>
                                                    Candidates must have strong business knowledge and should have
                                                    first-person experience in one or more sales roles.
                                                </p>
                                                <ul>
                                                    <li>
                                                        The content of this exam was updated on July 23, 2021. Please
