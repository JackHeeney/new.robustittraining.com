...
$title = "Robust IT Training | Microsoft | Functional Consultant | Microsoft Certified: Customer Data Platform Specialty";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /microsoft/functional-consultant/microsoft-certified-customer-data-platform-specialty";
            ...
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li><a href="<?php echo SITE_ADDR ?>/vendor/microsoft/functional-consultant">Functional
                            Consultant</a></li>
                    <li class="current">Microsoft Certified: Customer Data Platform Specialty
                    </li>
                </ul>
            </div>
        </div>
                            ...
                            <div class="work-content">
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <p>
                                            If your specialty is implementing solutions that provide insight
                                            into customer profiles and that track engagement activities to help
                                            improve customer experiences and increase customer retention, this
                                            certification could validate your skills and help open career doors.
                                        </p>
                                        <p>
                                            As a candidate for this certification, you should have firsthand
                                            experience with Dynamics 365 Customer Insights, Power Query,
                                            Microsoft Dataverse, Common Data Model, Microsoft Power Platform and
                                            one or more additional Dynamics 365 apps. In addition, you need
                                            direct experience with practices related to privacy, compliance,
                                            consent, security, responsible AI, and data retention policy.
                                        </p>
                                        <p>
                                            You also need experience with processes related to KPIs, data
                                            retention, validation, visualization, preparation, matching,
                                            fragmentation, segmentation, and enhancement. You should have a
                                            general understanding of Azure Machine Learning, Azure Synapse
                                            Analytics, and Azure Data Factory.
                                        </p>
                                        <p>
                                            If you need more experience before you try to earn this
                                            certification, here are some suggestions:
                                        </p>
                                        <ul>
                                            <li>Work as a Microsoft Dynamics 365 consultant on Customer Insights
                                                projects</li>
                                            <li>Join the Dynamics 365 community. You don’t have to be a certificate
                                                holder</li>
