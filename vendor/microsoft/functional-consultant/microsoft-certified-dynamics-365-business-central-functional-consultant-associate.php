...
$title = "Robust IT Training | Microsoft | Functional Consultant | Microsoft Certified: Dynamics 365: Central Functional Consultant Associate";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /microsoft/functional-consultant/microsoft-certified-dynamics-365-business-central-functional-consultant-associate.php";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">Microsoft Certified: Dynamics 365: Central Functional Consultant Associate
                </h1>
            ...
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li><a href="<?php echo SITE_ADDR ?>/vendor/microsoft/functional-consultant">Functional
                            Consultant</a></li>
                    <li class="current">Microsoft Certified: Dynamics 365: Central Functional Consultant Associate
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-mb-800-microsoft-dynamics-365-business-central-functional-consultant-skills-measured.pdf"
                                    target="_blank" alt="download MB-800 exam guide">
                                    Download the MB-800 guide
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <div class="alert alert-primary">
                                            ...
                                            <br />
                                            The English language version of this certification was updated on February
                                            14, 2022. Please download the skills measured document on the Exam MB-800
                                            page to see what changed.
                                        </div>
                                        <p>
                                            If you’re a functional consultant who implements core Microsoft Dynamics 365
                                            Business Central setup processes for small and medium-sized businesses, this
                                            certification is for you. You need to have experience configuring Dynamics
                                            365 Business Central role centers, including adapting insights, cues, action
                                            tiles, reports, and charts. And you should be able to extend Business
                                            Central by using Microsoft Power Platform components.
                                        </p>
                                        <p>
                                            You must have applied knowledge of Business Central, and you should
                                            understand industry terminology, priorities, standards, methodologies, and
                                            best practices. If you have this knowledge and you’re in a role such as
                                            administrator, quality assurance, DevOps, developer, UX designer, or
                                            solution architect, the Dynamics 365 Business Central Functional Consultant
                                            Associate certification could be a great fit.
                                        </p>
                                        <p>
                                        ...
                                        <ul>
                                            <li>Work as a Business Central functional consultant on one or more projects
                                            </li>
                                            <li>Contribute to a Business Central consulting project, or help deliver a
                                                Business Central implementation</li>
                                            <li>Find a mentor</li>
                                            <li>Join the Dynamics 365 Community</li>
                                            <li>Take available learning paths on Microsoft Learn, and complete more
                                                hands-on practice</li>
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for Business Central Functional Consultant
                            professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            ...
                            <small>The average business central functional consultant salary in the United Kingdom is
                                £62,500 per year or £32.05 per hour. Entry level positions start at £55,000 per year
                                while most experienced workers make up to £87,750 per year</small>.
                        </div>
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="alert alert-primary">
                                                    ...
                                                    14, 2022. Please download the skills measured document below to see
                                                    what changed.
                                                </div>
                                                <p>
                                                    Candidates for this exam are functional consultants who implement
                                                    core application setup processes for small and medium businesses.
                                                    They implement and configure Microsoft Dynamics 365 Business Central
                                                    including setting up core functionality and modules and migrating
                                                    data to Business Central.
                                                </p>
                                                <p>
                                                    Candidates configure the application in collaboration with the
                                                    implementation team to provide the business with manageability and
                                                    ease of use. They may configure role centers including adapting
                                                    insights, cues, action tiles, reports, charts, and extend Business
                                                    Central by using Microsoft Power Platform components.
                                                </p>
                                                <p>
                                                    Candidates have applied knowledge of meeting business needs by using
                                                    Business Central, including basic understanding of financial
                                                    management, sales, purchasing, and inventory.
                                                </p>
                                                <p>
                                                    Candidates for this exam typically specialize in one or more feature
                                                    sets of Business Central. They understand the role of Business
                                                    Central in relationship to the Microsoft 365 and Dynamics 365 suites
                                                    of applications.
                                                </p>
                                                <ul>
                                                    <li>The English language version of this exam was updated on
                                                        February 14, 2022. Please download the exam skills outline below
                                                        to see what changed.</li>
                                                    <li>Set up Business Central (20-25%)</li>
                                                    <li>Configure financials (30-35%)
                                                    </li>
                                                    <li>Configure sales and purchasing (15-20%)</li>
                                                    <li>Perform Business Central operations (25-30%)</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
