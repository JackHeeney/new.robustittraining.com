...
$title = "Robust IT Training | Microsoft | Functional Consultant | Microsoft Certified: Dynamics 365: Supply Chain Management Functional Consultant Associate";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /microsoft/functional-consultant/microsoft-certified-dynamics-365-supply-chain-management-functional-consultant-associate";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">Microsoft Certified: Dynamics 365: Supply Chain Management Functional Consultant
                    Associate
                </h1>
            ...
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li><a href="<?php echo SITE_ADDR ?>/vendor/microsoft/functional-consultant">Functional
                            Consultant</a></li>
                    <li class="current">Microsoft Certified: Dynamics 365: Supply Chain Management Functional Consultant
                        Associate
                    </li>
                </ul>
            </div>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                ...
                                <a class="btn btn-outline-secondary btn-hover--secondary mt-5"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-mb-330-microsoft-dynamics-365-supply-chain-management-functional-consultant-skills-measured.pdf"
                                    target="_blank" alt="download MB-330 exam guide">
                                    Download the MB-330 guide
                                    <i class="fas fa-download fcr-animate"></i>
                                </a>
                            </div>
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <div class="alert alert-primary">
                                            ...
                                            <br />
                                            The content of this certification was updated recently. Exam MB-330 was
                                            updated on December 10, 2021. Exam MB-300 was updated on August 9, 2021.
                                            Please download the skills measured documents on the associated exam pages
                                            to see changes.
                                        </div>
                                        <p>
                                            As a candidate for the Microsoft Dynamics 365 Supply Chain Management
                                            Functional Consultant Associate certification, you’re a functional
                                            consultant or a business user with a fundamental understanding of supply
                                            chain management industry standards. You have experience configuring and
                                            implementing Dynamics 365 Supply Chain Management to meet the needs of your
                                            organization. You’re a key resource who works with developers, solution
                                            architects, project managers, and functional consultants in finance,
                                            commerce, and manufacturing.
                                        </p>
                                        <p>
                                            To further accelerate your career, consider combining this certification
                                            with the Dynamics 365 Supply Chain Management, Manufacturing Functional
                                            Consultant Associate certification (Exam MB-320) and the Dynamics 365:
                                            Finance and Operations Apps Solution Architect Expert certification (Exam
                                            MB-700).
                                        </p>
                                        <p>
                                        ...
                                        <ul>
                                            <li>Study the supply chain management modules on Microsoft Learn, and
                                                complete more hands-on practice</li>
                                            <li>Sign up for an instructor-led training course that covers the MB-300 or
                                                MB-330 track</li>
                                            <li>Take part in the community at community.dynamics.com, or join a user
                                                group</li>
                                            <li>Shadow a supply chain management functional consultant and help to
                                                implement Dynamics 365 Supply Chain Management functionalities</li>
                                            <li>Get a mentor, tour warehouses, and learn how things are made</li>
                    ...
                    <div class="row align-items-center my-lg-20 my-12">
                        ...
                        <div class="col-xl-5 col-lg-6 col-12" data-aos="fade-up">
                            ...
                            <div class="skill-with-video-content">
                                ...
                                <!-- Agency List End -->
                                <a href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/microsoft-certified-dynamics-365-supply-chain-management-functional-consultant-associate-skills-measured.pdf"
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for Supply Chain Management
                            professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            <h2 class="title mb-5">
                                <div class="salary text-white">£<span class="counter">43,589.00</span>+</div>
                            </h2>
                            <small>The average supply chain management salary in the United Kingdom is £43,589 per year
                                or £22.35 per hour. Entry level positions start at £30,350 per year while most
                                experienced workers make up to £67,500 per year</small>.
                        </div>
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="alert alert-primary">
                                                    <i class="fa fa-info-circle pr-1"></i> <strong>Important</strong>
                                                    <br />
                                                    The content of this exam was updated on August 9, 2021. Please
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        Microsoft Power Platform technologies (20–25%)
                                                    </li>
                                                    <li>
                                        ...
                                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                            ...
                                            <div class="card-body">
                                                <div class="alert alert-primary">
                                                    <i class="fa fa-info-circle pr-1"></i> <strong>Important</strong>
                                                    <br />
                                                    The content of this exam was updated on December 10, 2021. Please
                                                    download the skills measured document below to see what changed.
                                                </div>
                                                <p>
                                                    Candidates for this exam are supply chain management functional
                                                    consultants who design and configure Dynamics 365 Supply Chain
                                                    Management and related tools and technologies to meet the
                                                    requirements for a customer. They analyze business requirements and
                                                    translate those requirements into fully realized business processes
                                                    and solutions that implement industry-recommended practices.
                                                    Candidates partner with architects, developers, administrators, and
                                                    other stakeholders to deliver solutions that meet or exceed the
                                                    needs of their customers.
                                                </p>
                                                <p>
                                                    Candidates implement product information management, sales and
                                                    procurement processes, inventory and warehouse management, master
                                                    planning, and transportation management.
                                                </p>
                                                <ul>
                                                    <li>
                                                        The content of this exam was updated on December 10, 2021.
