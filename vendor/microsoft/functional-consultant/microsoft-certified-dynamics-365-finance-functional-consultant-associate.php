...
$title = "Robust IT Training | Microsoft | Functional Consultant | Microsoft Certified: Dynamics 365: Finance Functional Consultant Associate";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /microsoft/functional-consultant/microsoft-certified-dynamics-365-finance-functional-consultant-associate";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">Microsoft Certified: Dynamics 365: Finance Functional Consultant Associate
                </h1>
            ...
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li><a href="<?php echo SITE_ADDR ?>/vendor/microsoft/functional-consultant">Functional
                            Consultant</a></li>
                    <li class="current">Microsoft Certified: Dynamics 365: Finance Functional Consultant Associate
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                ...
                                <a class="btn btn-outline-secondary btn-hover--secondary mt-5"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-mb-310-microsoft-dynamics-365-finance-skills-measured.pdf"
                                    target="_blank" alt="download MB-310 exam guide">
                                    Download the MB-310 guide
                                    <i class="fas fa-download fcr-animate"></i>
                                </a>
                            </div>
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <div class="alert alert-primary">
                                            ...
                                            Exam MB-300 was updated on August 9, 2021, and Exam MB-310 was updated on
                                            August 27, 2021. Please download the skills measured documents on the
                                            associated exam pages to see what changed.
                                        </div>
                                        <p>
                                            Use this certification to prove your skills and help advance your career, if
                                            you have experience as a functional consultant who analyzes business
                                            requirements and translates them into successful business processes and
                                            solutions based on industry best practices. You need to have experience in
                                            implementing and configuring Dynamics 365 Finance to meet business
                                            requirements.
                                        </p>
                                        <p>
                                            This certification is a good fit for people in finance departments who work
                                            in accounts receivable, accounts payable, general ledger, fixed assets,
                                            budgeting, cost accounting and cost management, or expenses. You must have a
                                            fundamental understanding of business accounting principles and financial
                                            operations.
                                        </p>
                                        <p>
                                        ...
                                        <ul>
                                            <li>Work with a functional consultant who uses Dynamics 365 Finance
                                            </li>
                                            <li>Work as a functional consultant on one or more projects</li>
                                            <li>Work on a finance consulting project</li>
                    ...
                    <div class="row align-items-center my-lg-20 my-12">
                        ...
                        <div class="col-xl-5 col-lg-6 col-12" data-aos="fade-up">
                            ...
                            <div class="skill-with-video-content">
                                ...
                                <!-- Agency List End -->
                                <a href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/microsoft-certified-dynamics-365-finance-functional-consultant-associate-skills-measured.pdf"
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for Finance Functional Consultant
                            professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            ...
                            <small>The average finance functional consultant salary in the United Kingdom is £65,000 per
                                year or £33.33 per hour. Entry level positions start at £57,500 per year while most
                                experienced workers make up to £75,125 per year</small>.
                        </div>
                                ...
                                <div class="col-12 col-xl-6">
                                    ...
                                    <ul class="agency-list">
                                        ...
                                        <li class="item">
                                            ...
                                            <div class="text">
                                                Functional Consultant - Projects & Finance
                                            </div>
                                        </li>
                                        <li class="item">
                                            <div class="icon">
                                ...
                                <div class="col-12 col-xl-6">
                                    ...
                                    <ul class="agency-list">
                                        <li class="item">
                                            ...
                                            <div class="text">
                                                Senior Functional Finance Consultant
                                            </div>
                                        </li>
                                        <li class="item">
                                            <div class="icon">
                                        ...
                                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                            ...
                                            <div class="card-body">
                                                <div class="alert alert-primary">
                                                    <i class="fa fa-info-circle pr-1"></i> <strong>Important</strong>
                                                    <br />
                                                    The English language version of this exam was updated on August 27,
                                                    2021. Please download the skills measured document below to see what
                                                    changed.
                                                </div>
                                                <p>
                                                    Candidates for this exam analyze business requirements and translate
                                                    those requirements into fully realized business processes and
                                                    solutions that implement industry recommended practices. They have a
                                                    fundamental understanding of accounting principles and a deeper
                                                    understanding of financial operations as they relate to core
                                                    finance, manufacturing, retail, and supply chain management
                                                    operations.
                                                </p>
                                                <p>
                                                    Candidates for this exam typically specialize in one or more feature
                                                    sets of Dynamics 365 Finance including core finance, general ledger,
                                                    tax, cost accounting, fixed assets, budgeting, revenue recognition,
                                                    consolidation, credit and collections, cash and bank management,
                                                    expense management, and project management and accounting. They
                                                    understand the relationships between finance and manufacturing,
                                                    retail, and supply chain management.
                                                </p>
                                                <ul>
                                                    <li>
                                                        The content of this exam was updated on August 27, 2021. Please
                                                        download the exam skills outline below to see what changed.
                                                    </li>
                                                    <li>
