...
$title = "Robust IT Training | Microsoft | Functional Consultant | Microsoft Certified: Power Platform Functional Consultant Associate";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /microsoft/functional-consultant/microsoft-certified-power-platform-functional-consultant-associate";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">Microsoft Certified: Power Platform Functional Consultant Associate
                </h1>
            ...
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li><a href="<?php echo SITE_ADDR ?>/vendor/microsoft/functional-consultant">Functional
                            Consultant</a></li>
                    <li class="current">Microsoft Certified: Power Platform Functional Consultant Associate
                    </li>
                </ul>
            </div>
        </div>
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <div class="alert alert-primary">
                                            ...
                                            <br />
                                            The content of this certification was updated on October 1, 2021. Please
                                            download the skills measured document on the Exam PL-200 page to see what
                                            changed.
                                        </div>
                                        <p>
                                            Are you a functional consultant, data analyst, or developer looking to hone
                                            your consulting and configuration skills, or solution architect on a path to
                                            the solution architect certification? Or maybe you’re an IT professional
                                            with knowledge and experience configuring Microsoft Power Platform. If this
                                            describes you and you’re familiar with using Power Platform components to
                                            extend and customize Microsoft apps and services such as Teams, Dynamics
                                            365, Excel, and Word, explore how the Microsoft Power Platform Functional
                                            Consultant Associate certification can help enhance your career and make you
                                            a key member of your team. This certification indicates to the world that
                                            you’re considered qualified to build and implement solutions that use Power
                                            Apps, Power BI, and Power Virtual Agents.
                                        </p>
                                        <p>
                                            As a candidate for this certification, you work with an organization’s
                                            stakeholders and subject matter experts, such as solution architects,
                                            developers, and testers, to gather requirements and then implement Microsoft
                                            Power Platform solutions. You build model-driven, canvas, and portal apps.
                                            And you create Power Automate flows, design chatbots using Power Virtual
                                            Agents, and analyze data using Power BI visualization and dashboards. You
                                            even create application enhancements, custom user experiences, system
                                            integrations, data conversions, custom process automation, and custom
                                            visualizations.
                                        </p>
                                        <p>
                                            As a functional consultant, use this certification to market yourself more
                                            effectively for projects and other engagements. The Microsoft Power Platform
                                            Functional Consultant Associate certification lets organizations know
                                            that—with no code or low code—you can build solutions that would normally
                                        ...
                                        <ul>
                                            <li>Build a basic dashboard using Power BI</li>
                    ...
                    <div class="row align-items-center my-lg-20 my-12">
                        ...
                        <div class="col-xl-5 col-lg-6 col-12" data-aos="fade-up">
                            ...
                            <div class="skill-with-video-content">
                                ...
                                <!-- Agency List End -->
                                <a href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/microsoft-certified-power-platform-functional-consultant-associate-skills-measured.pdf"
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for Power Platform Functional Consultant
                            professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            ...
                            <small>The average power platform functional consultant salary in the United Kingdom is
                                £60,000 per year or £30.77 per hour. Entry level positions start at £48,750 per year
                                while most experienced workers make up to £60,000 per year</small>.
                        </div>
