            ...
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 mb-n6">
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image"
                                href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-azure-solutions-architect-expert"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/microsoft/expert.jpg"
                                    alt="expert.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-azure-solutions-architect-expert">Microsoft
                            ...
                            <a
                                href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-azure-solutions-architect-expert">View
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image"
                                href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-dynamics-365-finance-and-operations-apps-solutions-architect-expert"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/microsoft/expert.jpg"
                                    alt="expert.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-dynamics-365-finance-and-operations-apps-solutions-architect-expert">Microsoft
                            ...
                            <a
                                href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-dynamics-365-finance-and-operations-apps-solutions-architect-expert">View
                                Course <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image"
                                href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-azure-for-sap-workloads-specialty"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/microsoft/specialty.jpg"
                                    alt="specialty.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-azure-for-sap-workloads-specialty">Microsoft
                            ...
                            <a
                                href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-azure-for-sap-workloads-specialty">View
                                Course <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image"
                                href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-power-platform-solution-architect-expert"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/microsoft/expert.jpg"
                                    alt="expert.jpg"></a>
                        </div>
                        <div class="info">
