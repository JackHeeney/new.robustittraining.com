...
$title = "Robust IT Training | Microsoft | Solutions Architect Certifications";
$meta['keywords'] = "";
$meta['description'] = "";

// Social media meta tags
$meta['og:title'] = "Robust IT Training | Microsoft | Solutions Architect Certifications";
$meta['og:description'] = "";
$meta['og:image'] = "";
$meta['og:url'] = "";

$leadIsFrom = "Lead is from /microsoft/solutions-architect";
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">Solutions Architect</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="section section-padding-t90-b100">
        <div class="container">
            ...
            <div class="section-title text-center " data-aos="fade-up">
                <h2 class="title fz-32"> Solutions Architect Certifications :</h2>
                <p>Explore solutions architect certifications most sought after by employers</p>
            </div>
            <!-- Section Title End -->
            ...
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 mb-n6">
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-azure-solutions-architect-expert"><img src="<?php echo SITE_ADDR ?>/assets/images/project/project-1.jpg" alt="work"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-azure-solutions-architect-expert">Microsoft
                            ...
                            <a href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-azure-solutions-architect-expert">View
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-dynamics-365-finance-and-operations-apps-solutions-architect-expert"><img src="<?php echo SITE_ADDR ?>/assets/images/project/project-2.jpg" alt="work"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-dynamics-365-finance-and-operations-apps-solutions-architect-expert">Microsoft
                            ...
                            <a href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-dynamics-365-finance-and-operations-apps-solutions-architect-expert">View
                                Courses <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-azure-for-sap-workloads-specialty"><img src="<?php echo SITE_ADDR ?>/assets/images/project/project-3.jpg" alt="work"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-azure-for-sap-workloads-specialty">Microsoft
                            ...
                            <a href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-azure-for-sap-workloads-specialty">View
                                Courses <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-power-platform-solution-architect-expert"><img src="<?php echo SITE_ADDR ?>/assets/images/project/project-4.jpg" alt="work"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-power-platform-solution-architect-expert">Microsoft
                            ...
                            <a href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect/microsoft-certified-power-platform-solution-architect-expert">View
                                Courses <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                </div>
