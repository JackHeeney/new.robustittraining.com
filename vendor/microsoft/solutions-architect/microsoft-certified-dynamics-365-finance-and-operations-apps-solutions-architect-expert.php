...
$title = "Robust IT Training | Microsoft | Solutions Architect | Microsoft Certified: Dynamics 365: Finance & Operations ";
$meta['keywords'] = "";
$meta['description'] = "";
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">Power Platform Solutions Architect</li>
                </ul>
            </div>
        </div>
    </div>
