...
$title = "Robust IT Training | Microsoft | Developer | Microsoft Certified: Power Platform Developer Associate";
$meta['keywords'] = "";
$meta['description'] = "";

// Social media meta tags
$title = "Robust IT Training | Microsoft | Developer | Microsoft Certified: Power Platform Developer Associate Apps Developer Associate";
$meta['og:description'] = "";
$meta['og:image'] = "";
$meta['og:url'] = "";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">Microsoft Certified: Power Platform Developer Associate
                </h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">Power Platform Developer</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-pl-400-microsoft-power-platform-developer-skills-measured.pdf"
                                    target="_blank" alt="download PL-400 exam guide">
                                    Download the PL-400 guide
                            ...
                            <div class="work-content">
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <p>
                                            If you have a passion for designing, developing, securing, and extending
                                            Microsoft Power Platform solutions, this certification could be for you. To
                                            earn this certification, you must be able to create solution components,
                                            including application enhancements, custom user experience, system
                                            integrations, data conversions, custom process automation, and custom
                                            visualizations. You need a strong applied knowledge of Microsoft Power
                                            Platform services and a basic understanding of DevOps practices for
                                            Microsoft Power Platform. Plus, your background should include development
                                            experience using JavaScript, JSON, TypeScript, C#, HTML, .NET, Azure,
                                            Microsoft 365, RESTful web services, ASP.NET, and Power BI.
                                        </p>
                                        <p>
                                            Candidates for this certification typically work with app makers, functional
                                            consultants, solution architects, and IT administrators. You have varied
                                        ...
                                        <p>
                                            To learn more, check out our blog post: New certification: Microsoft Power
                                            Platform Developer Associate. If you need more experience before you try for
                                            this certification, you could:
                                        </p>
                                        <ul>
                                            <li>
                                                Volunteer on a Microsoft Power Platform development project to get
                                                hands-on experience
                                            </li>
                                            <li>
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for Power Platform Developer
                            professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            ...
                            <small>The average power platform developer salary in the United Kingdom is £52,500 per year
                                or £26.92 per hour. Entry level positions start at £40,000 per year while most
                                experienced workers make up to £75,000 per year</small>.
                        </div>
                                ...
                                <div class="col-12 col-xl-6">
                                    ...
                                    <ul class="agency-list">
                                        ...
                                        <li class="item">
                                            ...
                                            <div class="text">
                                                Dynamics CRM + Power & Cloud Platform
                                            </div>
                                        </li>
                                        <li class="item">
                                            <div class="icon">
                                ...
                                <div class="agency-accordion max-mb-n30" id="accordionExample">
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    Candidates for this exam design, develop, secure, and troubleshoot
                                                    Power Platform solutions. Candidates implement components of a
                                                    solution, including application enhancements, custom user
                                                    experience, system integrations, data conversions, custom process
                                                    automation, and custom visualizations.
                                                </p>
                                                <p>
                                                    Candidates must have strong applied knowledge of Power Platform
                                                    services, including in-depth understanding of capabilities,
                                                    boundaries, and constraints. Candidates should have a basic
                                                    understanding of DevOps practices for Power Platform.
                                                </p>
                                                <p>
                                                    Candidates should have development experience that includes Power
                                                    Platform services, JavaScript, JSON, TypeScript, C#, HTML, .NET,
                                                    Microsoft Azure, Microsoft 365, RESTful web services, ASP.NET, and
                                                    Microsoft Power BI.
                                                </p>
                                                <p>
                                                    The English language version of this exam was updated on March 14,
                                                    2022. Please download the exam skills outline below to see what
                                                    changed
                                                </p>
                                                <ul>
                                                    <li>Create a technical design (10-15%)</li>
                                                    <li>Configure Microsoft Dataverse (10-15%)</li>
                                                    <li>Create and configure Power Apps (5-10%)</li>
                                                    <li>Configure business process automation (5-10%)</li>
                                                    <li>Extend the user experience (15-20%)</li>
                                                    <li>Extend the platform (20-25%)</li>
