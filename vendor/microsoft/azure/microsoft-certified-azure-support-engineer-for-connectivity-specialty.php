...
$title = "Robust IT Training | Microsoft | Azure | Microsoft Certified: Azure Support Engineer for Connectivity Specialty";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /microsoft/azure/microsoft-certified-azure-support-engineer-for-connectivity-specialty";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">Microsoft Certified: Azure Support Engineer for Connectivity Specialty</h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li><a href="<?php echo SITE_ADDR ?>/vendor/microsoft/azure">Azure</a>
                    </li>
                    <li class="current">Microsoft Certified: Azure Support Engineer for Connectivity Specialty</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    ...
                                    target="_blank" alt="download SC-300 exam guide">
                                    Download the SC-300 guide
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <div class="alert alert-primary">
                                            ...
                                            28, 2022. Please download the skills measured document on the Exam SC-300
                                        ...
                                        <p>
                                            ...
                                            Azure Active Directory (Azure AD). They manage tasks such as providing
                                            secure authentication and authorization access to enterprise applications.
                                            The administrator provides seamless experiences and self-service management
                                            capabilities for all users. Adaptive access and governance are core elements
                                            to the role. This role is also responsible for troubleshooting, monitoring,
                                            and reporting for the identity and access environment.
                                        </p>
                                        <p>
                                            The identity and access administrator may be a single individual or a member
                                            of a larger team. This role collaborates with many other roles in the
                                            organization to drive strategic identity projects to modernize identity
                                            solutions, to implement hybrid identity solutions, and to implement identity
                                            governance.
                                        </p>
                    ...
                    <div class="row align-items-center my-lg-20 my-12">
                        ...
                        <div class="col-xl-5 col-lg-6 col-12" data-aos="fade-up">
                            ...
                            <div class="skill-with-video-content">
                                ...
                                <!-- Agency List End -->
                                <a href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/microsoft certified-identity-and-access-administrator-associate-skills-measured.pdf"
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for Identity and Access
                            professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            ...
                            <small>The average identity and access salary in the United Kingdom is £60,000 per year or
                                £30.77 per hour. Entry level positions start at £45,881 per year while most experienced
                                workers make up to £81,900 per year</small>.
                        </div>
                                ...
                                <div class="col-12 col-xl-6">
                                    ...
                                    <ul class="agency-list">
                                        ...
                                        <li class="item">
                                            ...
                                            <div class="text">
                                                IT Identity and Access manager
                                            </div>
                                        </li>
                                        <li class="item">
                                            <div class="icon">
                                ...
                                <div class="agency-accordion max-mb-n30" id="accordionExample">
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    The Microsoft identity and access administrator designs, implements,
                                                    and operates an organization’s identity and access management
                                                    systems by using Azure Active Directory (Azure AD). They manage
                                                    tasks such as providing secure authentication and authorization
                                                    access to enterprise applications. The administrator provides
                                                    seamless experiences and self-service management capabilities for
                                                    all users. Adaptive access and governance are core elements to the
                                                    role. This role is also responsible for troubleshooting, monitoring,
                                                    and reporting for the identity and access environment.
                                                </p>
                                                <p>
                                                    The identity and access administrator may be a single individual or
                                                    a member of a larger team. This role collaborates with many other
                                                    roles in the organization to drive strategic identity projects to
                                                ...
                                                <ul>
                                                    <li>The English language version of this exam was updated on January
                                                        ...
                                                        what changed.</li>
                                                    <li>Implement an identity management solution (25-30%)
                                                    </li>
                                                    <li>Implement an authentication and access management solution
                                                        (25-30%)</li>
                                                    <li>Implement access management for apps (10-15%)
                                                    </li>
                                                    <li>Plan and implement an identity governance strategy (25-30%)
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
