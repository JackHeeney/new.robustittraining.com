...
$title = "Robust IT Training | Microsoft | DevOps Engineer | Microsoft Certified: DevOps Engineer Expert";
$meta['keywords'] = "";
$meta['description'] = "";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">Microsoft Certified: DevOps Engineer Expert</h1>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-az-400-designing-and-implementing-microsoft-devops-solutions-skills-measured.pdf"
                                    target="_blank" alt="download AZ-400 exam guide">
                                    Download the AZ-400 guide
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <div class="alert alert-primary">
                                            ...
                                            download the skills measured document on the Exam AZ-400 page to see what
                                            changed.
                                        </div>
                                        <p>
                                            Candidates for the DevOps Engineer Expert certification should have subject
                                            matter expertise working with people, processes, and technologies to
                                            continuously deliver business value.
                                        </p>
                                        <p>
                                            Responsibilities for this role include designing and implementing strategies
                                            for collaboration, code, infrastructure, source control, security,
                                            compliance, continuous integration, testing, delivery, monitoring, and
                                            feedback.
                                        </p>
                                        <p>
                                            A candidate for this certification must be familiar with both Azure
                                            administration and development and must be expert in at least one of these
                                            areas.
                                        </p>
                                        ...
                                        <div class="details-list mb-10">
                                            ...
                                            <span class="pre-links">
                                                ...
                                                <ul>
                                                    <li>
                                                        <a class="text-rb-gradient" target="_blank" href="#"
                    ...
                    <div class="row align-items-center my-lg-20 my-12">
                        ...
                        <div class="col-xl-5 col-lg-6 col-12" data-aos="fade-up">
                            ...
                            <div class="skill-with-video-content">
                                ...
                                <!-- Agency List End -->
                                <a href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/microsoft-certified-devops-engineer-expert-skills-measured.pdf"
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for DevOps Engineer
                            professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            ...
                            <small>The average devops engineer salary in the United Kingdom is £60,000 per year or
                                £30.77 per hour. Entry level positions start at £47,676 per year while most experienced
                                workers make up to £80,000 per year</small>.
                        </div>
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    ...
                                                    working with people, processes, and technologies to continuously
                                                    deliver business value.
                                                </p>
                                                <p>
                                                    Responsibilities for this role include designing and implementing
                                                    strategies for collaboration, code, infrastructure, source control,
                                                ...
                                                <p>
                                                    ...
                                                    administration and development and must be expert in at least one of
                                                    these areas.
                                                </p>
                                                <ul>
                                                    <li>The content of this exam was updated on November 30, 2021.
                                                        Please download the exam skills outline below to see what
                                                        changed.</li>
                                                    <li>Develop an instrumentation strategy (5-10%)</li>
                                                    <li>Develop a Site Reliability Engineering (SRE) strategy (5-10%)
                                                    </li>
                                                    ...
                                                    <li>Define and implement a continuous delivery and release
                                                        management strategy (10-15%)</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
