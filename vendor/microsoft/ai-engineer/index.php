...
$title = "Robust IT Training | Microsoft | AI Engineer Certifications";
$meta['keywords'] = "";
$meta['description'] = "";

// Social media meta tags
$meta['og:title'] = "Robust IT Training | Microsoft | AI Engineer Certifications";
$meta['og:description'] = "";
$meta['og:image'] = "";
$meta['og:url'] = "";
...
<div id="page" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7" data-bg-image="<?php echo SITE_ADDR ?>/assets/images/bg/breadcrumb-bg-two.jpg">
        <div class="page-title">
            <div class="container">
                <h1 class="title">AI Engineer certifications</h1>
            </div>
        </div>
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">AI Engineer</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="section section-padding-t90-b100">
        <div class="container">
            ...
            <div class="section-title text-center " data-aos="fade-up">
                <h2 class="title fz-32">AI Engineer Certifications :</h2>
                <p>Explore ai engineer certifications most sought after by employers</p>
            </div>
            <!-- Section Title End -->
            ...
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 mb-n6">
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/vendor/microsoft/ai-engineer/microsoft-certified-azure-ai-engineer-associate"><img src="<?php echo SITE_ADDR ?>/assets/images/project/project-2.jpg" alt="work"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a href="<?php echo SITE_ADDR ?>/vendor/microsoft/ai-engineer/microsoft-certified-azure-ai-engineer-associate">Microsoft
                            ...
                            <a href="<?php echo SITE_ADDR ?>/vendor/microsoft/ai-engineer/microsoft-certified-azure-ai-engineer-associate">View
