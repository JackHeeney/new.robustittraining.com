            ...
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 mb-n6">
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image"
                                href="<?php echo SITE_ADDR ?>/vendor/microsoft/data-engineer/microsoft-certified-azure-data-engineer-associate"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/microsoft/associate.jpg"
                                    alt="associate.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<?php echo SITE_ADDR ?>/vendor/microsoft/data-engineer/microsoft-certified-azure-data-engineer-associate">Microsoft
                            ...
                            <a
                                href="<?php echo SITE_ADDR ?>/vendor/microsoft/data-engineer/microsoft-certified-azure-data-engineer-associate">View
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image"
                                href="<?php echo SITE_ADDR ?>/vendor/microsoft/data-engineer/microsoft-certified-customer-data-platform-specialty"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/microsoft/specialty.jpg"
                                    alt="specialty.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<?php echo SITE_ADDR ?>/vendor/microsoft/data-engineer/microsoft-certified-customer-data-platform-specialty">Microsoft
                            ...
                            <a
                                href="<?php echo SITE_ADDR ?>/vendor/microsoft/data-engineer/microsoft-certified-customer-data-platform-specialty">View
                                Course <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                </div>
