...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7" data-bg-image="<?php echo SITE_ADDR ?>/assets/images/bg/bg-certified-ethical-hacker.jpg">
        <div class="page-title">
            <div class="container">
                <h1 class="title">Microsoft Certified: Customer Data Platform Specialty</h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li><a href="<?php echo SITE_ADDR ?>/vendor/microsoft/data-engineer">Data Engineer</a></li>
                    <li class="current">Customer Data Platform Specialty</li>
                </ul>
            </div>
        </div>
    </div>
