...
$title = "Robust IT Training | Microsoft | Data Scientist Certifications";
$meta['keywords'] = "";
$meta['description'] = "";

// Social media meta tags
$meta['og:title'] = "Robust IT Training | Microsoft | Data Scientist Certifications";
$meta['og:description'] = "";
$meta['og:image'] = "";
$meta['og:url'] = "";
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">Data Scientist</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="section section-padding-t90-b100">
        <div class="container">
            ...
            <div class="section-title text-center " data-aos="fade-up">
                <h2 class="title fz-32">Data Scientist Certifications :</h2>
                <p>Explore data scientist certifications most sought after by employers</p>
            </div>
            <!-- Section Title End -->
            ...
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 mb-n6">
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<? echo SITE_ADDR ?>/vendor/microsoft/data-scientist/microsoft-certified-azure-data-scientist-associate"><img src="<? echo SITE_ADDR ?>/assets/images/project/project-1.jpg" alt="work"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a href="<? echo SITE_ADDR ?>/vendor/microsoft/data-scientist/microsoft-certified-azure-data-scientist-associate">Microsoft
                            ...
                            <a href="<? echo SITE_ADDR ?>/vendor/microsoft/data-scientist/microsoft-certified-azure-data-scientist-associate">View
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<? echo SITE_ADDR ?>/vendor/microsoft/data-scientist/microsoft-certified-customer-data-platform-specialty"><img src="<? echo SITE_ADDR ?>/assets/images/project/project-2.jpg" alt="work"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a href="<? echo SITE_ADDR ?>/vendor/microsoft/data-scientist/microsoft-certified-customer-data-platform-specialty">Microsoft
                            ...
                            <a href="<? echo SITE_ADDR ?>/vendor/microsoft/data-scientist/microsoft-certified-customer-data-platform-specialty">View
                                Courses <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                </div>
