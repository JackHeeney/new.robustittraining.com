            ...
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 mb-n6">
                ...
                <div class="col mb-6">
                    <div class="work">
                        <div class="thumbnail">
                            <a class="image"
                                href="<? echo SITE_ADDR ?>/vendor/microsoft/data-scientist/microsoft-certified-azure-data-scientist-associate"><img
                                    src="<? echo SITE_ADDR ?>/assets/images/project/project-1.jpg" alt="work"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<? echo SITE_ADDR ?>/vendor/microsoft/data-scientist/microsoft-certified-azure-data-scientist-associate">Microsoft
                            ...
                            <a
                                href="<? echo SITE_ADDR ?>/vendor/microsoft/data-scientist/microsoft-certified-azure-data-scientist-associate">View
                ...
                <div class="col mb-6">
                    <div class="work">
                        <div class="thumbnail">
                            <a class="image"
                                href="<? echo SITE_ADDR ?>/vendor/microsoft/data-scientist/microsoft-certified-customer-data-platform-specialty"><img
                                    src="<? echo SITE_ADDR ?>/assets/images/project/project-2.jpg" alt="work"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<? echo SITE_ADDR ?>/vendor/microsoft/data-scientist/microsoft-certified-customer-data-platform-specialty">Microsoft
                            ...
                            <a
                                href="<? echo SITE_ADDR ?>/vendor/microsoft/data-scientist/microsoft-certified-customer-data-platform-specialty">View
                                Courses <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                </div>
