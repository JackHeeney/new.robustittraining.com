            ...
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 mb-n6">
                ...
                <div class="col mb-6">
                    <div class="work">
                        ...
                        <div class="info">
                            <h3 class="title"><a href="#">EC-Council</a></h3>
                ...
                <div class="col mb-6">
                    <div class="work">
                        ...
                        <div class="info">
                            <h3 class="title"><a href="#">Amazon Web Services</a></h3>
                ...
                <div class="col mb-6">
                    <div class="work">
                        ...
                        <div class="info">
                            <h3 class="title"><a href="#">Microsoft</a></h3>
                            <p class="desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda esse
                                culpa, unde perspiciatis hic delectus.</p>
                            <a href="#">View Project <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                ...
                <div class="col mb-6">
                    <div class="work">
                        ...
                        <div class="info">
                            <h3 class="title"><a href="#">CompTIA</a></h3>
                            <p class="desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda esse
                                culpa, unde perspiciatis hic delectus.</p>
                            <a href="#">View Project <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                ...
                <div class="col mb-6">
                    <div class="work">
                        ...
                        <div class="info">
                            <h3 class="title"><a href="#">CISCO</a></h3>
                            <p class="desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda esse
                                culpa, unde perspiciatis hic delectus.</p>
                            <a href="#">View Project <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                ...
                <div class="col mb-6">
                    <div class="work">
                        ...
                        <div class="info">
                            <h3 class="title"><a href="#">Axelos</a></h3>
                            <p class="desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda esse
                                culpa, unde perspiciatis hic delectus.</p>
                            <a href="#">View Project <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                ...
                <div class="col mb-6">
                    <div class="work">
                        ...
                        <div class="info">
                            <h3 class="title"><a href="#">ISACA</a></h3>
                            <p class="desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda esse
                                culpa, unde perspiciatis hic delectus.</p>
                            <a href="#">View Project <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                ...
                <div class="col mb-6">
                    <div class="work">
                        ...
                        <div class="info">
                            <h3 class="title"><a href="#">(ISC)&#178;</a></h3>
                            <p class="desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda esse
                                culpa, unde perspiciatis hic delectus.</p>
                            <a href="#">View Project <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                ...
                <div class="col-xl-5 col-lg-6 col-12" data-aos="fade-up">
                    ...
                    <div class="about-content-area">
                        ...
                        <div class="section-title-two">
                            ...
                            <h3 class="title">Find your course by searching by career.</h3>
                        </div>
