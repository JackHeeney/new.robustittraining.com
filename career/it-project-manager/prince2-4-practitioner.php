...
$title = "Robust IT Training | Axelos | PRINCE2 | PRINCE2 4 Practitioner";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /career/it-project-manager/prince2-4-practitioner";
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li><a href="<?php echo SITE_ADDR ?>/career/it-project-manager">IT Project Manager</a></li>
                    <li class="current">PRINCE2&#174; 4 Practitioner</li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="work-left work-details" data-aos="fade-up">
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-details-list my-10">
                                ...
                                <div class="details-list">
                                    <label>Length</label>
                                    <span>150 minutes to complete the exam</span>
                                </div>

                                <div class="details-list">
                                    <label>Format</label>
                                    <span>
                                        68 questions per paper<br>
                            ...
                            <div class="details-list mb-10">
                                <label>Extra</label>
                                <span>
                                    Open book. Candidates are permitted to use the official printed hard copy of the
                                    Managing Successful Projects with PRINCE2® 2017 Edition. The official manual may
                                    be annotated and tabulated but no sticky notes and loose leaf papers containing
                                    additional notes will be allowed.
                                </span>
                            </div>
                            <!-- End Details List -->
                            ...
                            <div class="work-content">
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <p>
                                            PRINCE2 Practitioner certification is suitable for anyone managing projects.
                                            This could be as part of a formal project management function or a role
                                            which involves project management as part of day-to-day work. The
                                            Practitioner certification aims to confirm that you have sufficient
                                            knowledge and understanding to apply and tailor the method in a range of
                                            different project environments and scenarios.
                                        </p>
                                        <p>
                                            Attaining your Practitioner qualification is only one part of becoming a
                                            successful and effective project manager. It is important to ensure that you
                                            supplement this with real-life experience working on projects, in addition
                                            to investing in personal professional development and wider training.
                                        </p>
                                        <p>
                                            Typically, classroom training for PRINCE2 Practitioner lasts one and a half
                                            days and the examination takes place at the end of the training (this will
                                            vary depending on training provider). However, you can self-study for the
                                            Practitioner exam and you may also choose to take the training in another
                                            format such as distance learning. Training is delivered by Axelos'
                                            Accredited Training Organizations (ATOs) who set their own rates, so prices
                                            will vary.
                                        </p>
                                    </div>

                                    <div class="content mb-10" data-aos="fade-up">
                                        <h6 class="title" data-aos="fade-up">Who should do this?
                                        </h6>

                                        <p>
                                            This certification is aimed at project managers, aspiring project managers
                                            and anyone who manages projects. It is also relevant to other key staff
                                            involved in the design, development and delivery of projects, including:
                                            Project Board members (e.g. Senior Responsible Owners), Team Managers (e.g.
                                            Product Delivery Managers), Project Assurance (e.g. Business Change
                                            Analysts), Project Support (e.g. Project and Programme Office personnel) and
                                    ...
                                    <div class="content mb-10" data-aos="fade-up">
                                        <h6 class="title" data-aos="fade-up">Pre-Requisites
                                        </h6>
                                        <p>
                                            To take the PRINCE2 Practitioner examination you must provide proof of
                                            having passed one of the following:
                                        </p>

                                        <ul>
                                            <li>PRINCE2 5th Edition (Foundation or Practitioner)
                                            </li>
                                            <li>PRINCE2 6th Edition (Foundation)
                                            </li>
                                            <li>Project Management Qualification (PMQ)*</li>
                                            <li>Project Professional Qualification (PPQ)*
                                            </li>
                                            ...
                                            <li>IPMA Level A® (Certified Projects Director)***
                                            </li>
                                            <li>IPMA Level B® (Certified Senior Project Manager)***
                                            </li>
                                            <li>IPMA Level C® (Certified Project Manager)***
                                            </li>
                                            <li>IPMA Level D® (Certified Project Management Associate).***
                                            </li>
                                        </ul>
                                        <p>
                                            For more information on which certifications are now recognized as approved
                                            prior learning for the PRINCE2 Practitioner certification, please refer to
                                            our guide:
                                        </p>


                                        <div class="agency-accordion mt-5" id="princePrerequisites">
                                            <div class="card">
                                                ...
                                                https://eu-assets.contentstack.com/v3/assets/blt637b065823946b12/blt305391567d3df119/PRINCE-pre-recognition.pdf"
                                                        ...
                                                        <br><br>
                                                        *‘PMQ and PPQ’ are registered marks of the Association for
                                                        Project Management
                                                        <br><br>
                                                        *‘PMQ’ is a registered mark of the Association for Project
                                                        Management.
                                                        <br><br>
                                                        **'PMP and CAPM' are registered marks of the Project Management
                                                        Institute, Inc.
                                                        <br><br>
                                                        ***‘IPMA Level A/B/C/D’ are registered trademarks of the
                                                        International Project Management Association.
                                                        <br><br>
                                                        APM, PMI and IPMA are not affiliated with Axelos, nor do they
                                                        endorse any Axelos qualifications.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="content mb-10" data-aos="fade-up">
                                        <h6 class="title" data-aos="fade-up">Certification Expiry Date
                                        </h6>

                                        <p>
                                            The PRINCE2 Practitioner certification will expire after 3 years. In order
                                            to maintain your qualification and ensure there are no gaps in your
                                            Practitioner status, you can either retake the PRINCE2 Practitioner Exam
                                            before the expiry date or maintain your certification through CPD points and
                                            a digital badge. If you choose to follow the CPD route you will need to
                                            purchase a subscription to My PRINCE2 which costs £50 + VAT per year.
                                        </p>
                                    </div>
                        ...
                        <div class="col-xl-5 col-lg-6 col-12" data-aos="fade-up">
                            ...
                            <div class="skill-with-video-content">
                                ...
                                <div class="section-title-two mb-8">
                                    ...
                                    <span class="sub-title">Reasons why to take the PRINCE2 4 Foundation</span>
                                    <h2 class="title">
                                        Why use PRINCE2?
                                    </h2>
                                </div>
            ...
            <div class="text-white row my-lg-10 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            <h2 class="title mb-5">
                                <div class="salary text-white">£<span class="counter">47,333.00</span>+</div>
                            </h2>
                            <small>The average prince2 salary in the United Kingdom is £47,333 per year or £24.27 per
                                hour. Entry level positions start at £35,000 per year while most experienced workers
                                make up to £62,500 per year</small>.
                        </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                ...
                                                their teams.
                                                <br><br>
                                                The method can be applied to any project, regardless of it’s size,
                                                industry or project type and can be tailored to the specific needs of
                                                each project undertaken. PRINCE2 uses 7 Themes, 7 Principles and 7
                                                Processes to ensure the project remains truly PRINCE2, ensuring best
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                            ...
                                            <div class="card-body">
                                                ...
                                                projects. Later the method was enriched and altered to a generic project
                                                management model to be used by the UK government in their projects and
                                                the method became known as PRINCE.
                                                <br><br>
                                                The 2nd version, which is the method as we know it today, was unveiled
                                                in 1996 and the name was changed to PRINCE2, flowing over into the
                                                private sector. In 2009 PRINCE2 underwent a revamp involving the input
                                                of about 150 organisations that had used the method.
                                                <br><br>
                                                The ownership rights to PRINCE2 were transferred from the HM Cabinet
                                                Office to AXELOS in 2013
                                            </div>
                                        </div>
                                    </div>
