...
$title = "Robust IT Training | Axelos | ITIL | ITIL 4 Foundation";
$meta['keywords'] = "";
$meta['description'] = "";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">ITIL&#174; 4 Foundation</h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">ITIL&#174; 4 Foundation</li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="work-left work-details" data-aos="fade-up">
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-details-course-logo">
                                <img src="<?php echo SITE_ADDR ?>/assets/images/logo/axelos/itil/itil-4-logo.png"
                                    alt="ITIL 4 logo" class="w-100">
                            </div>
                            <!-- Start Details List -->
                            <div class="work-details-list my-10">
                                ...
                                <div class="details-list">
                                    <label>Format</label>
                                    <span>
                                        40 questions, multiple choice <br>
                                ...
                                <div class="details-list">
                                    ...
                                    <span>
                                        Before sitting a Managing Professional or Strategic Leader exam, you must first
                                        pass Foundation.
                                    </span>
                                </div>
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    ...
                                    target="_blank" alt="download ITIL exam guide">
                            ...
                            <div class="work-content">
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        ...
                                        <p>
                                            ITIL 4 Foundation is for anyone who needs to understand the key concepts of
                                            IT and digital service delivery, and who is interested in helping their
                                            organization embrace the new service management culture. It is for
                                            professionals at the start of their ITIL 4 journey or people looking to
                                            update their existing ITIL knowledge.
                                        </p>
                                        <p>
                                    ...
                                    <div class="content mb-10" data-aos="fade-up">
                                        <h6 class="title" data-aos="fade-up">The course will help you to understand:
                                        </h6>

                                        <p>
                                            This course would benefit those working in a service delivery or service
                                            desk discipline, as well as IT professionals who are interested in adopting
                                            or have adopted ITIL® within their organisation. Different job roles that
                                            can benefit from ITIL® certifications include:
                                        </p>
                                        <ul>
                                            ...
                                            <li>Anyone working in a service delivery or service desk discipline.</li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="content mb-10" data-aos="fade-up">
                                        ...
                                        <ul>
                                            ...
                                            <li>how cultural or behavioural principles guide work that benefits the
                                                wider organization</li>
                                            <li>how to use commonly-used service management terms and concepts</li>
                                        </ul>
                                    </div>

                                    <div class="content mb-10" data-aos="fade-up">
                                        <h6 class="title" data-aos="fade-up">ITIL 4 Foundation training
                                        </h6>

                                        <p>
                                            ITIL training courses are run by accredited training organizations, in a
                                            variety of formats. Use our training search to find a training provider.
                                        </p>
                                    </div>
                        ...
                        <div class="col-xl-5 col-lg-6 col-12" data-aos="fade-up">
                            ...
                            <div class="skill-with-video-content">
                                ...
                                <div class="section-title-two mb-8">
                                    ...
                                    <span class="sub-title">Reasons why to take the ITIL 4 Foundation</span>
                                    <h2 class="title">
                                        Why use ITIL?
                                    </h2>
                                </div>
            ...
            <div class="text-white row my-lg-10 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for ITIL 4
                            Professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            <h2 class="title mb-5">
                                <div class="salary text-white">£<span class="counter">42,500.00</span>+</div>
                            </h2>
                            <small>The average itil 4 salary in the United Kingdom is £42,500 per year or £21.79 per
                                hour. Entry level positions start at £31,150 per year while most experienced workers
                                make up to £62,558 per year</small>.
                        </div>
                                ...
                                <div class="agency-accordion max-mb-n30" id="accordionExample">
                                    <div class="card">
                                        <div class="card-header" id="headingOne">
                                            <h5 class="mb-0">
                                                <a href="#" class="acc-btn border-0" data-toggle="collapse"
                                                    ...
                                                    What is ITIL® and why it is important?
                                                </a>
                                            </h5>
                                        </div>
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                ...
                                                best practices for delivering IT services. ITIL® is important because
                                                its systematic approaches for IT service management can help businesses
                                                to manage risks, establish cost-effective practices, strengthen customer
                                                relations, and build a stable IT environment that allows growth, scale
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingTwo">
                                            <h5 class="mb-0">
                                                <a href="#" class="acc-btn border-0 collapsed" data-toggle="collapse"
                                                    ...
                                                    How can ITIL® help different businesses?
                                                </a>
                                            </h5>
                                        </div>
                                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                            data-parent="#accordionExample">
                                            <div class="card-body">
                                                ITIL® defined specific sets of processes, which helps businesses to:
                                                <ul>
                                                    <li>Deliver maximum customers value.</li>
                                                    <li>Optimise business resources and capabilities.</li>
                                                    <li>Plan the processes to achieve a particular business goal.</li>
                                                    <li>Define each role clearly for each task.</li>
                                                    <li>Establish cost-effective guidelines and more.</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingThree">
                                            <h5 class="mb-0">
                                                <a href="#" class="acc-btn border-0 collapsed" data-toggle="collapse"
                                                    ...
                                                    How ITIL® training courses can help me in my career growth?
                                                </a>
                                            </h5>
                                        </div>
                                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                            data-parent="#accordionExample">
                                            <div class="card-body">
                                                Professionals who hold an ITIL® certification get higher rank in
                                                companies and get paid more than any average IT Professional.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour"
                                            data-parent="#accordionExample">
                                            <div class="card-body">
                                                Although ITSM is a technical discipline dealing with the efficient
                                                design, deployment and implementation of IT services, ITIL is a tool
                                                that IT practitioners can use in their organisations to incorporate best
                                                practices for ITSM and progress towards a more efficient IT environment.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingFive">
                                            <h5 class="mb-0">
                                                <a href="#" class="acc-btn border-0 collapsed" data-toggle="collapse"
                                                    ...
                                                    What is new in ITIL 4 foundation?
                                                </a>
                                            </h5>
                                        </div>
                                        <div id="collapseFive" class="collapse" aria-labelledby="headingFive"
                                            data-parent="#accordionExample">
                                            <div class="card-body">
                                                ITIL 4 Framework acts as an introduction to the framework, offering
                                                delegates with a description of current approach of AXELOS to ITSM. This
                                                involves a description of the end-to-end 'Service Value System (SVS)'
                                                along with newly integrated frameworks with ITIL such as DevOps, Agile
                                                and Lean. ITIL 4 Framework acts as an introduction to the framework,
                                                offering delegates with a description of current approach of AXELOS to
                                                ITSM. This involves a description of the end-to-end 'Service Value
                                                System (SVS)' along with newly integrated frameworks with ITIL such as
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingSix">
                                            <h5 class="mb-0">
                                                <a href="#" class="acc-btn border-0 collapsed" data-toggle="collapse"
                                                    ...
                                                    How an ITIL® Certification can help me in my intellectual and
                                                    business growth?
                                                </a>
                                            </h5>
                                        </div>
                                        <div id="collapseSix" class="collapse" aria-labelledby="headingSix"
                                            data-parent="#accordionExample">
                                            <div class="card-body">
                                                By taking ITIL® Certification, you will gain comprehensive knowledge of
                                                widely used ITIL® framework, in which you will learn:
                                                <ul>
                                                    <li>How to understand customers need.</li>
                                                    <li>How to build long-term relationships.</li>
                                                    <li>How to improve your reputation.</li>
                                                    <li>How to increase productivity and improve the resource management
                                                        system.</li>
                                                    <li>How to manage risks without interrupting business services and
                                                        more</li>
                                                </ul>
                                            </div>
                                        </div>
