...
$title = "Robust IT Training | Microsoft | Microsoft 365 Certified: Teams Administrator Associate";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /microsoft/administrator/microsoft-365-certified-teams-administrator-associate";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">Microsoft 365 Certified: Teams Administrator Associate</h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">Microsoft 365 Certified: Teams Administrator Associate</li>
                </ul>
            </div>
        </div>
    </div>
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <div class="alert alert-primary">
                                            ...
                                            The content of this certification was updated on September 24, 2021. Please
                                            download the skills measured document on the Exam MS-700 page to see what
                                            changed.
                                        </div>
                                        <p>
                                            Candidates for this certification are Microsoft Teams administrators who
                                            manage Microsoft Teams to facilitate efficient and effective collaboration
                                            and communication in a Microsoft 365 environment.
                                        </p>
                                        <p>
                                            Candidates for this certification must be able to plan, deploy, configure,
                                            and secure Teams chat, apps, channels, meetings, audio/video conferencing,
                                            live events, calling, and Microsoft Teams-certified devices.
                                        </p>
                    ...
                    <div class="row align-items-center my-lg-20 my-12">
                        ...
                        <div class="col-xl-5 col-lg-6 col-12" data-aos="fade-up">
                            ...
                            <div class="skill-with-video-content">
                                ...
                                <!-- Agency List End -->
                                <a href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/microsoft-365-certified-teams-administrator-associate-skills-measured.pdf"
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for Microsoft Teams
                            professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            ...
                            <small>The average microsoft teams salary in the United Kingdom is £70,000 per year or
                                £35.90 per hour. Entry level positions start at £49,075 per year while most experienced
                                workers make up to £95,000 per year</small>.
                        </div>
                                ...
                                <div class="col-12 col-xl-6">
                                    ...
                                    <ul class="agency-list">
                                        ...
                                        <li class="item">
                                            ...
                                            <div class="text">
                                                Microsoft Teams Voice and Video Architect
                                            </div>
                                        </li>
                                ...
                                <div class="agency-accordion max-mb-n30" id="accordionExample">
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    Candidates for this exam are Microsoft Teams administrators who
                                                    manage Microsoft Teams to facilitate efficient and effective
                                                    collaboration and communication in a Microsoft 365 environment.
                                                </p>
                                                <p>
                                                    Candidates for this exam must be able to plan, deploy, configure,
                                                    and secure Teams chat, apps, channels, meetings, audio/video
                                                    conferencing, live events, calling, and Microsoft Teams-certified
                                                    devices. Candidates should have experience integrating Microsoft
                                                    Teams with other workloads, including SharePoint, OneDrive,
                                                    Exchange, Microsoft 365 Groups, Power Platform, and with other
                                                    Microsoft apps, third-party apps, and custom apps.
                                                </p>
                                                <p>
                                                    A Microsoft Teams administrator also collaborates other functions,
                                                    such as networking, telephony, licensing, security, compliance, user
                                                    adoption, app development, and support.
                                                </p>
                                                <ul>
                                                    <li>The content of this exam was updated on September 24, 2021.
                                                        Please download the exam skills outline below to see what
                                                        changed.</li>
                                                    <li>Plan and configure a Microsoft Teams environment (35-40%)
                                                    </li>
                                                    <li>Manage chat, teams, channels, and apps (25-30%)</li>
                                                    <li>Manage calling and meetings (15-20%)
                                                    </li>
                                                    <li>Monitor and troubleshoot a Microsoft Teams environment (10-15%)
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
