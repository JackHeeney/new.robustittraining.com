...
$title = "Robust IT Training | Microsoft | Microsoft 365 Certified: Teams Voice Engineer Expert";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /microsoft/administrator/microsoft-365-certified-teams-voice-engineer-expert";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">Microsoft 365 Certified: Teams Voice Engineer Expert</h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">Microsoft 365 Certified: Teams Voice Engineer Expert</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-ms-700-managing-microsoft-teams-skills-measured.pdf"
                                    target="_blank" alt="download MS-700 exam guide">
                                    Download the MS-700 guide
                                    <i class="fas fa-download fcr-animate"></i>
                                </a>
                                <a class="btn btn-outline-secondary btn-hover--secondary mt-5"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-ms-720-microsoft-teams-voice-engineer-skills-measured.pdf"
                                    target="_blank" alt="download MS-720 exam guide">
                                    Download the MS-720 guide
                                    <i class="fas fa-download fcr-animate"></i>
                                </a>
                            </div>
                            ...
                            <div class="work-content">
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        ...
                                        <p>
                                            If you’re a telecommunications professional that knows how to plan, design,
                                            configure, maintain, and troubleshoot an integrated communications solution
                                            using Microsoft Teams, this expert certification can help you move your
                                            career forward.
                                        </p>
                                        <p>
                                            This certification covers Microsoft Teams Phone with Calling Plans, Direct
                                            Routing, and Operator Connect, in addition to Microsoft Teams devices,
                                            audio/video conferencing, and voice migration.
                                        </p>
                                        <p>
                                            Candidates are familiar with telecommunication technologies and have
                                            experience with Microsoft Teams, Microsoft 365, and PowerShell. Candidates
                                            collaborate with telephony providers and third-party vendors to enable
                                            advanced voice features in Microsoft Teams.
                                        </p>

                                        <div class="details-list mb-10">
                                            <label>Prerequisites</label>
                                            <span class="pre-links">
                                                To become a Microsoft 365 Certified: Teams Voice Engineer Expert,
                    ...
                    <div class="row align-items-center my-lg-20 my-12">
                        ...
                        <div class="col-xl-5 col-lg-6 col-12" data-aos="fade-up">
                            ...
                            <div class="skill-with-video-content">
                                ...
                                <!-- Agency List End -->
                                <a href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/microsoft-365-certified-teams-voice-engineer-expert-skills-measured.pdf"
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for Teams Voice Engineer
                            professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            <h2 class="title mb-5">
                                <div class="salary text-white">£<span class="counter">75,000.00</span>+</div>
                            </h2>
                            <small>The average teams voice engineer salary in the United Kingdom is £75,000 per year or
                                £38.46 per hour. Entry level positions start at £75,000 per year while most experienced
                                workers make up to £89,250 per year</small>.
                        </div>
                                ...
                                <div class="col-12 col-xl-6">
                                    ...
                                    <ul class="agency-list">
                                        ...
                                        <li class="item">
                                            ...
                                            <div class="text">
                                                Microsoft Teams Voice Support Engineer
                                            </div>
                                        </li>
                                ...
                                <div class="col-12 col-xl-6">
                                    ...
                                    <ul class="agency-list">
                                        ...
                                        <li class="item">
                                            ...
                                            <div class="text">
                                                Senior Teams Voice And Video Engineer
                                            </div>
                                        </li>
                                    </ul>
                                    <!-- job roles List End -->
                                ...
                                <div class="agency-accordion max-mb-n30" id="accordionExample">
                                    <div class="card">
                                        <div class="card-header" id="headingOne">
                                            <h5 class="mb-0">
                                                <a href="#" class="acc-btn border-0" data-toggle="collapse"
                                                    ...
                                                    Exam MS-720: Microsoft Teams Voice Engineer
                                                </a>
                                            </h5>
                                        </div>
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    Candidates for this exam are Microsoft Teams voice engineers that
                                                    plan, design, configure, maintain, and troubleshoot integrated
                                                    communications solutions at an organization. They must be able to
                                                    translate business requirements into technical architecture and
                                                    designs for communication solutions.
                                                </p>
                                                <p>
                                                    Candidates are familiar with telecommunication technologies and have
                                                    experience with Microsoft Teams, Microsoft 365, and PowerShell. They
                                                    must be able to deploy and configure Microsoft Teams Phone with PSTN
                                                    connectivity through Direct Routing, Operator Connect, and Microsoft
                                                    Teams Calling Plans. Candidates also manage devices certified for
                                                    Microsoft Teams, audio/video conferencing, and voice migration.
                                                </p>
                                                <p>
                                                    Candidates collaborate with telephony providers and third-party
                                                    vendors to enable advanced voice features in Microsoft Teams. They
                                                    also work with administrators for other workloads, including
                                                    networking, identity, licensing, security, and compliance.
                                                </p>
                                                <ul>
                                                    <li>Plan and configure Microsoft Teams Phone (25-30%)</li>
                                                    <li>Optimize network performance (5-10%)
                                                    </li>
                                                    <li>Plan and configure Direct Routing (15-20%)</li>
                                                    <li>Configure and manage Microsoft Teams Phone for voice users
                                                        (15-20%)
                                                    </li>
                                                    <li>Plan and configure Microsoft Teams clients and devices (5-10%)
                                                    </li>
                                                    <li>Monitor and troubleshoot Microsoft Teams Phone (15-20%)</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
