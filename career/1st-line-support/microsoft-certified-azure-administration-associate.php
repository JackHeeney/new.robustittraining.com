...
$title = "Robust IT Training | Microsoft | Microsoft Certified Azure Administration Associate";
$meta['keywords'] = "";
$meta['description'] = "";
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-az-104-microsoft-azure-administrator-skills-measured.pdf"
                                    target="_blank" alt="download AZ-104 exam guide">
                                    Download the AZ-104 guide
