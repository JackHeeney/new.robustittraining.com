...
$title = "Robust IT Training | Microsoft | Microsoft 365 Certified: Messaging Administrator Associate";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /microsoft/administrator/microsoft-365-certified-messaging-administrator-associate";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">Microsoft 365 Certified: Messaging Administrator Associate</h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">Microsoft 365 Certified: Messaging Administrator Associate</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-ms-203-microsoft-365-messaging-skills-measured.pdf"
                                    target="_blank" alt="download MS-203 exam guide">
                                    Download the MS-203 guide
                            ...
                            <div class="work-content">
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <p>
                                            Microsoft 365 Messaging Administrators deploy, configure, manage,
                                            troubleshoot, and monitor recipients, compliance, threat protection, and
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for Messaging Administrator
                            professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            <h2 class="title mb-5">
                                <div class="salary text-white">£<span class="counter">45,855.00</span>+</div>
                            </h2>
                            <small>The average messaging administrator salary in the United Kingdom is £45,855 per year
                                or £23.52 per hour. Entry level positions start at £45,641 per year while most
                                experienced workers make up to £86,255 per year</small>.
                        </div>
                                ...
                                <div class="col-12 col-xl-6">
                                    ...
                                    <ul class="agency-list">
                                        ...
                                        <li class="item">
                                            ...
                                            <div class="text">
                                                Messaging & Collaboration Manager
                                            </div>
                                        </li>
                                        <li class="item">
                                            <div class="icon">
                                ...
                                <div class="agency-accordion max-mb-n30" id="accordionExample">
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    Candidates for this exam are messaging administrators who deploy,
                                                    configure, manage, troubleshoot, and monitor recipients, compliance,
                                                    threat protection, and mail flow in hybrid and cloud enterprise
                                                    environments.
                                                </p>
                                                <p>
                                                    Messaging administrators are responsible for managing message
                                                    hygiene, permissions, messaging infrastructure, hybrid
                                                    configuration, migration, transport, mailboxes, and client access.
                                                </p>
                                                <p>
                                                    Messaging administrators collaborate with other workload
                                                    administrators and the Microsoft 365 enterprise administrator to
                                                    implement a secure hybrid or cloud-only messaging topology that
                                                    meets the business needs of an enterprise
                                                </p>
                                                <p>
                                                    The messaging administrator should have a working knowledge of
                                                    authentication types, licensing, and integration with Microsoft 365
                                                    applications
                                                </p>
                                                <ul>
                                                    <li>The content of this exam was updated on November 22, 2021.
                                                        ...
                                                        changed.</li>
                                                    <li>Manage organizational settings and resources (30-35%)
                                                    </li>
                                                    <li>Plan and manage the mail transport architecture (20-25%)</li>
                                                    <li>Plan and implement a hybrid configuration and migration (15-20%)
                                                    </li>
                                                    <li>Secure the messaging environment (25-30%)</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
