                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-md-100-windows-client-skills-measured.pdf"
                                    target="_blank" alt="download MD-100 exam guide">
                                    Download the MD-100 guide
                                    <i class="fas fa-download fcr-animate"></i>
                                </a>
                                <a class="btn btn-outline-secondary btn-hover--secondary mt-5"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-md-101-managing-modern-desktops-skills-measured.pdf"
                                    target="_blank" alt="download MD-101 exam guide">
                                    Download the MD-101 guide
                                    <i class="fas fa-download fcr-animate"></i>
                                </a>
                            </div>
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p>
                                                    ...
                                                    maintaining Windows Client and non-Windows devices and technologies.
                                                </p>
                                                <ul>
                                                    <li>The content of this exam was updated on December 3, 2021. Please
                                                        download the exam skills outline below to see what changed.</li>
                                                    <li>Deploy Windows (15-20%)
                                                    </li>
                                                    <li>Manage devices and data (25-30%)</li>
                                                    <li>Configure storage and connectivity (15-20%)
                                                    </li>
                                                    <li>Maintain Windows (30-35%)</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
