...
$title = "Robust IT Training | Microsoft | Microsoft Certified: Information Protection Administrator Associate";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /microsoft/administrator/microsoft-certified-information-protection-administrator-associate";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">Microsoft Certified: Information Protection Administrator Associate</h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">Microsoft Certified: Information Protection Administrator Associate</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-sc-300-microsoft-identity-and-access-administrator-skills-measured.pdf"
                                    target="_blank" alt="download SC-400 exam guide">
                                    Download the SC-400 guide
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <div class="alert alert-primary">
                                            ...
                                            28, 2022. Please download the skills measured document on the Exam SC-400
                                            page to see what changed.
                                        </div>
                                        <p>
                                            The Microsoft information protection administrator plans and implements
                                            controls that meet organizational compliance needs. This person is
                                            responsible for translating requirements and compliance controls into
                                            technical implementation. They assist organizational control owners to
                                            become and stay compliant.
                                        </p>
                                        <p>
                                            They work with information technology (IT) personnel, business application
                                            owners, human resources, and legal stakeholders to implement technology that
                                            supports policies and controls necessary to sufficiently address regulatory
                                            requirements for their organization. They also work with the compliance and
                                            security leadership, such as a chief compliance officer and security
                                            officer, to evaluate the full breadth of associated enterprise risk and
                                            partner to develop those policies.
                                        </p>
                                        <p>
                                            This person defines applicable requirements and tests IT processes and
                                            operations against those policies and controls. They are responsible for
                                            creating policies and rules for content classification, data loss
                    ...
                    <div class="row align-items-center my-lg-20 my-12">
                        ...
                        <div class="col-xl-5 col-lg-6 col-12" data-aos="fade-up">
                            ...
                            <div class="skill-with-video-content">
                                ...
                                <!-- Agency List End -->
                                <a href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/microsoft microsoft-certified-information-protection-administrator-associate-skills-measured.pdf"
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for Information Protection
                            professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            <h2 class="title mb-5">
                                <div class="salary text-white">£<span class="counter">44,949.00</span>+</div>
                            </h2>
                            <small>The average information protection salary in the United Kingdom is £44,949 per year
                                or £23.05 per hour. Entry level positions start at £35,000 per year while most
                                experienced workers make up to £70,000 per year</small>.
                        </div>
                                ...
                                <div class="agency-accordion max-mb-n30" id="accordionExample">
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    The Microsoft information protection administrator plans and
                                                    implements controls that meet organizational compliance needs. This
                                                    person is responsible for translating requirements and compliance
                                                    controls into technical implementation. They assist organizational
                                                    control owners to become and stay compliant.
                                                </p>
                                                <p>
                                                    They work with information technology (IT) personnel, business
                                                    application owners, human resources, and legal stakeholders to
                                                    implement technology that supports policies and controls necessary
                                                    to sufficiently address regulatory requirements for their
                                                    organization. They also work with the compliance and security
                                                    leadership, such as a chief compliance officer and security officer,
                                                    to evaluate the full breadth of associated enterprise risk and
                                                    partner to develop those policies.
                                                </p>
                                                <p>
                                                    This person defines applicable requirements and tests IT processes
                                                    and operations against those policies and controls. They are
                                                    responsible for creating policies and rules for content
                                                    classification, data loss prevention, governance, and protection.
                                                </p>
                                                <ul>
                                                    <li>The English language version of this exam was updated on January
                                                        28, 2022. Please download the exam skills outline below to see
                                                        what changed.</li>
                                                    <li>Implement information protection (35-40%)
                                                    </li>
                                                    <li>Implement data loss prevention (30-35%)
                                                    </li>
                                                    <li>Implement information governance (25-30%)
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
