...
$title = "Robust IT Training | Microsoft | Microsoft Certified: Azure Virtual Desktop Specialty";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /microsoft/administrator/microsoft-certified-azure-virtual-desktop-specialty";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">Microsoft Certified: Azure Virtual Desktop Specialty</h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">Microsoft Certified: Azure Virtual Desktop Specialty</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-details-course-logo">
                                <img src="<?php echo SITE_ADDR ?>/assets/images/logo/microsoft/microsoft-certified-specialty-badge.svg"
                                    alt="microsoft certified specialty badge" class="w-100">
                            </div>
                            <!-- Start Details List -->
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-az-140-configuring-and-operating-microsoft-azure-virtual-desktop-skills-measured.pdf"
                                    target="_blank" alt="download AZ-140 exam guide">
                                    Download the AZ-140 guide
                            ...
                            <div class="work-content">
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <p>
                                            Candidates for the Azure Virtual Desktop Specialty certification are
                                            Microsoft Azure administrators with subject matter expertise in planning,
                                            delivering, and managing virtual desktop experiences and remote apps, for
                                            any device, on Azure.
                                        </p>
                                        <p>
                                            Responsibilities for this role include deploying virtual desktop experiences
                                            and apps to Azure. Professionals in this role deliver applications on Azure
                                            Virtual Desktop and optimize them to run in multi-session virtual
                                            environments. To deliver these experiences, they work closely with Azure
                                            administrators and architects, along with Microsoft 365 administrators.
                                        </p>
                                        <p>
                                            Candidates for this certification should have experience in Azure
                                            technologies, including virtualization, networking, identity, storage,
                                            backups, resilience, and disaster recovery. They should understand
                                            on-premises virtual desktop infrastructure technologies as they relate to
                                            migrating to Azure Virtual Desktop. These professionals use the Azure portal
                                            and Azure Resource Manager (ARM) templates to accomplish many of their
                                            tasks. They might use PowerShell and Azure Command-Line Interface (CLI) for
                                            more efficient automation.
                                        </p>
                                        <p>
                                            Candidates for this certification must have expert Azure administration
                                            skills.
                                        </p>
                                    </div>
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for Azure Virtual Desktop professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            ...
                            <small>The average azure virtual desktop salary in the United Kingdom is £62,500 per year or
                                £32.05 per hour. Entry level positions start at £55,625 per year while most experienced
                                ...
                                <div class="agency-accordion max-mb-n30" id="accordionExample">
                                    <div class="card">
                                        <div class="card-header" id="headingOne">
                                            <h5 class="mb-0">
                                                <a href="#" class="acc-btn border-0" data-toggle="collapse"
                                                    ...
                                                    Exam AZ-140: Configuring and Operating Microsoft Azure Virtual
                                                    Desktop
                                                </a>
                                            </h5>
                                        </div>
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    Candidates for this exam are administrators with subject matter
                                                    expertise in planning, delivering, and managing virtual desktop
                                                    experiences and remote apps, for any device, on Azure.
                                                </p>
                                                <p>
                                                    Responsibilities for this role include deploying virtual desktop
                                                    experiences and apps to Azure. Professionals in this role deliver
                                                    applications on Azure Virtual Desktop and optimize them to run in
                                                    multi-session virtual environments. To deliver these experiences,
                                                    they work closely with the Azure administrators and architects,
                                                    along with Microsoft 365 Administrators.
                                                </p>
                                                <p>
                                                    Candidates for this exam should have experience in Azure
                                                    technologies, including virtualization, networking, identity,
                                                    storage, backups, resilience, and disaster recovery. They should
                                                    understand on-premises virtual desktop infrastructure technologies
                                                    as they relate to migrating to Azure Virtual Desktop. These
                                                    professionals use the Azure portal and Azure Resource Manager
                                                    templates to accomplish many tasks. This role may use PowerShell and
                                                    Azure Command-Line Interface (CLI) for more efficient automation.
                                                </p>
                                                <p>
                                                    Candidates for this exam must have expert Azure administration
                                                    skills.
                                                </p>
                                                <ul>
                                                    <li>The content of this exam was updated on November 22, 2021.
                                                        Please download the exam skills outline below to see what
                                                        changed.</li>
                                                    <li>Plan an Azure Virtual Desktop architecture (10-15%)
                                                    </li>
                                                    <li>Implement an Azure Virtual Desktop infrastructure (25-30%)</li>
                                                    <li>Manage access and security (10-15%)</li>
                                                    <li>Manage user environments and apps (20-25%)</li>
                                                    <li>Monitor and maintain an Azure Virtual Desktop infrastructure
                                                        (20-25%)</li>
                                                </ul>
                                            </div>
                                        </div>
