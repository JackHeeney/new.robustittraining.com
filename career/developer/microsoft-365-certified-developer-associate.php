...
$title = "Robust IT Training | Microsoft | Developer | Microsoft 365 Certified: Developer Associate";
$meta['keywords'] = "";
$meta['description'] = "";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">Microsoft 365 Certified: Developer Associate</h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">Developer Associate</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/microsoft-365-certified-developer-associate-skills-measured.pdf"
                                    target="_blank" alt="download MS-600 exam guide">
                                    Download the MS-600 guide
                            ...
                            <div class="work-content">
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <p>
                                            Microsoft 365 developers design, build, test, and maintain applications and
                                            solutions that are optimized for the productivity and collaboration needs of
                                            organizations using the Microsoft 365 platform.
                                        </p>
                                        <p>
                                            Microsoft 365 developers are proficient in Microsoft identity, Microsoft
                                            Graph, and building apps for Microsoft Teams. They have general knowledge on
                                            UI elements (including Fluent UI (Office UI Fabric), integration points
                                            (including Office Add-ins, SharePoint Framework, Actionable Messages), and
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for Developer Associate
                            professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            <h2 class="title mb-5">
                                <div class="salary text-white">£<span class="counter">33,500.00</span>+</div>
                            </h2>
                            <small>The average developer associate salary in the United Kingdom is £33,500 per year or
                                £17.18 per hour. Entry level positions start at £27,483 per year while most experienced
                                workers make up to £65,000 per year</small>.
                        </div>
                                ...
                                <div class="agency-accordion max-mb-n30" id="accordionExample">
                                    <div class="card">
                                        <div class="card-header" id="headingOne">
                                            <h5 class="mb-0">
                                                <a href="#" class="acc-btn border-0" data-toggle="collapse"
                                                    ...
                                                    Exam MS-600: Building Applications and Solutions with Microsoft 365
                                                    Core Services
                                                </a>
                                            </h5>
                                        </div>
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    Candidates for this exam are Microsoft 365 developers who design,
                                                    build, test, and maintain applications and solutions that are
                                                    optimized for the productivity and collaboration needs of
                                                    organizations using the Microsoft 365 platform.
                                                </p>
                                                <p>
                                                    Candidates for this exam are proficient in Microsoft identity,
                                                    Microsoft Graph, and building apps for Microsoft Teams. They have
                                                    general knowledge on UI elements (including Fluent UI (Office UI
                                                    Fabric), integration points (including Office Add-ins, SharePoint
                                                    Framework, Actionable Messages), and determining workload platform
                                                    targets.
                                                </p>
                                                <p>
                                                    Candidates should have experience developing solutions on Microsoft
                                                    Teams, Office, or SharePoint through all phases of software
                                                    development. They should have a basic understanding of REST APIs,
                                                    JSON, OAuth2, OData, OpenID Connect, Microsoft identities (including
                                                    Azure AD and Microsoft accounts), Azure AD B2C, and
                                                    permission/consent concepts.
                                                </p>
                                                <ul>
                                                    <li>The content of this exam was updated on November 29, 2021.
                                                        Please download the exam skills outline below to see what
                                                        changed.</li>
                                                    <li>Implement Microsoft identity (20-25%)</li>
                                                    <li>Build apps with Microsoft Graph (15-20%)</li>
                                                    <li>Extend and customize SharePoint (15-20%)</li>
                                                    <li>Extend Microsoft Teams (20-25%)</li>
                                                    <li>Extend Office (15-20%)</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
