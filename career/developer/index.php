            ...
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 mb-n6">
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/career/developer/aws-developer" alt="AWS
                            Developer"><img src="<?php echo SITE_ADDR ?>/assets/images/project/aws/aws-developer.jpg"
                                    alt="aws-developer.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a href="<?php echo SITE_ADDR ?>/career/developer/aws-developer" alt="AWS
                            Developer">AWS
                                    Developer</a>
                            </h3>
                            ...
                            <a href="<?php echo SITE_ADDR ?>/career/developer/aws-developer" alt="AWS
                            Developer">View
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image"
                                href="<?php echo SITE_ADDR ?>/career/developer/microsoft-certified-azure-developer-associate"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/microsoft/associate.jpg"
                                    alt="associate.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<?php echo SITE_ADDR ?>/career/developer/microsoft-certified-azure-developer-associate">Microsoft
                                    Certified:
                                    Azure Developer Associate</a></h3>
                            <p class="desc">Azure developers design, build, test, and maintain cloud applications and
                                services.</p>
                            <a
                                href="<?php echo SITE_ADDR ?>/career/developer/microsoft-certified-azure-developer-associate">View
                                Course <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image"
                                href="<?php echo SITE_ADDR ?>/career/developer/microsoft-certified-dynamics-365-finance-and-operations-apps-developer-associate"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/microsoft/associate.jpg"
                                    alt="associate.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<?php echo SITE_ADDR ?>/career/developer/microsoft-certified-dynamics-365-finance-and-operations-apps-developer-associate">Microsoft
                                    Certified:
                            ...
                            <a
                                href="<?php echo SITE_ADDR ?>/career/developer/microsoft-certified-dynamics-365-finance-and-operations-apps-developer-associate">View
                                Course <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image"
                                href="<?php echo SITE_ADDR ?>/career/developer/microsoft-365-certified-developer-associate"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/microsoft/associate.jpg"
                                    alt="associate.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<?php echo SITE_ADDR ?>/career/developer/microsoft-365-certified-developer-associate">Microsoft
                            ...
                            <a
                                href="<?php echo SITE_ADDR ?>/career/developer/microsoft-365-certified-developer-associate">View
                                Course <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image"
                                href="<?php echo SITE_ADDR ?>/career/developer/microsoft-certified-power-platform-developer-associate"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/microsoft/associate.jpg"
                                    alt="associate.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<?php echo SITE_ADDR ?>/career/developer/microsoft-certified-power-platform-developer-associate">Microsoft
                            ...
                            <a
                                href="<?php echo SITE_ADDR ?>/career/developer/microsoft-certified-power-platform-developer-associate">View
                                Course <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image"
                                href="<?php echo SITE_ADDR ?>/career/developer/microsoft-certified-azure-iot-developer-specialty"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/microsoft/specialty.jpg"
                                    alt="specialty.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<?php echo SITE_ADDR ?>/career/developer/microsoft-certified-azure-iot-developer-specialty">Microsoft
                                    Certified: Azure IoT
                                    Developer Specialty</a></h3>
                            <p class="desc">Azure IoT developers develop cloud and edge components of an Azure IoT
                                solution.</p>
                            <a
                                href="<?php echo SITE_ADDR ?>/career/developer/microsoft-certified-azure-iot-developer-specialty">View
                                Course <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image"
                                href="<?php echo SITE_ADDR ?>/career/developer/microsoft-certified-azure-cosmos-db-developer-specialty"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/microsoft/specialty.jpg"
                                    alt="specialty.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<?php echo SITE_ADDR ?>/career/developer/microsoft-certified-azure-cosmos-db-developer-specialty">Microsoft
                            ...
                            <p class="desc">Azure Cosmos DB developers design and implement data models and data
                                ...
                                solution.</p>
                            <a
                                href="<?php echo SITE_ADDR ?>/career/developer/microsoft-certified-azure-cosmos-db-developer-specialty">View
                                Course <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image"
                                href="<?php echo SITE_ADDR ?>/career/developer/microsoft-certified-azure-ai-engineer-associate"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/microsoft/associate.jpg"
                                    alt="associate.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<?php echo SITE_ADDR ?>/career/developer/microsoft-certified-azure-ai-engineer-associate">Microsoft
                                    Certified: Azure AI Engineer Associate</a></h3>
                            <p class="desc">Azure AI engineers build, manage, and deploy AI solutions that leverage
                                Azure Cognitive Services and Azure Applied AI services.</p>
                            <a
                                href="<?php echo SITE_ADDR ?>/career/developer/microsoft-certified-azure-ai-engineer-associate">View
                                Course <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/career/developer/python-programming"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/programming/python.jpg"
                                    alt="associate.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
