...
$title = "Robust IT Training | Microsoft | Developer | Microsoft Certified: Azure IOT Developer Specialty";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /career/developer/microsoft-certified-azure-iot-developer-specialty";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">Microsoft Certified: Azure IOT Developer Specialty
                </h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">Microsoft Certified: Azure IOT Developer Specialty</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-az-220-microsoft-azure-iot-developer-skills-measured.pdf"
                                    target="_blank" alt="download AZ-220 exam guide">
                                    Download the AZ-220 guide
                            ...
                            <div class="work-content">
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <p>
                                            Candidates for this certification should have subject matter expertise
                                            implementing the configuration and coding tasks required to create and
                                            maintain the cloud and edge portions of an IoT solution.
                                        </p>
                                        <p>
                                            Responsibilities for this role include deploying physical devices,
                                            configuring and maintaining them by using cloud services, and maintaining
                                            and troubleshooting the configuration throughout the device lifecycle.
                                        </p>
                                        <p>
                                        ...
                                        <p>
                                            Azure IoT Developers are also responsible for implementing design
                                            specifications for IoT solutions, including device topology, connectivity,
                                            diagnostics and monitoring, and security. These professionals develop and
                                            deploy modules and configure device networking for the Azure IoT Edge
                                            portion of the solution. In addition to this, they implement designs for
                                            solutions to manage data pipelines, including monitoring and data
                                            transformation as they relate to IoT
                                        </p>
                                        <p>
                                            Azure IoT Developers work with architects, data engineers, and other
                                            stakeholders to ensure successful business integration, including the
                                            implementation of the Azure Digital Twins service
                                        </p>
                                        <p>
                                            Candidates for this certification should have a general understanding of
                                            device types and Azure services, including data storage options, data
                                            analysis, data processing, AI, and other platform as a service (PaaS)
                                            options. They must be able to program in at least one Azure IoT software
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for Azure IoT Developer
                            professionals</span>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            ...
                            <small>The average azure iot developer salary in the United Kingdom is £55,000 per year or
                                £28.21 per hour. Entry level positions start at £45,000 per year while most experienced
                                workers make up to £68,250 per year</small>.
                        </div>
                                ...
                                <div class="agency-accordion max-mb-n30" id="accordionExample">
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    Candidates for this exam should have subject matter expertise
                                                    implementing the configuration and coding tasks required to create
                                                    and maintain the cloud and edge portions of an IoT solution.
                                                </p>
                                                <p>
                                                    Candidates for this exam should have a general understanding of
                                                    device types and Azure services, including data storage options,
                                                    data analysis, data processing, AI, and other platform as a service
                                                    (PaaS) options. They must be able to program in at least one Azure
                                                    IoT software development kit–supported (SDK–supported) language.
                                                </p>
                                                <ul>
                                                    <li>The content of this exam was updated on September 24, 2021.
                                                        Please download the exam skills outline below to see what
                                                        changed.
                                                    </li>
                                                    <li>Set up the IoT solution infrastructure (10-15%)</li>
                                                    <li>Provision and manage devices (15-20%)</li>
                                                    <li>Implement IoT Edge (15-20%)</li>
                                                    <li>Implement business integration (5-10%)</li>
                                                    <li>Process and manage data (15-20%)</li>
                                                    <li>Monitor, troubleshoot, and optimize IoT solutions (15-20%)</li>
                                                    <li>Implement security (10-15%)</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
