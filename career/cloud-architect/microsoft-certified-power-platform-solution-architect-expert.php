...
$title = "Robust IT Training | Microsoft | Solutions Architect | Microsoft Certified: Power Platform Solutions Architect Expert";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /career/cloud-architect/microsoft-certified-power-platform-solution-architect-expert";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">Microsoft Certified: Power Platform Solutions Architect Expert
                </h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">Microsoft Certified: Power Platform Solutions Architect Expert</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-pl-600-microsoft-power-platform-solution-architect-skills-measured.pdf"
                                    target="_blank" alt="download PL-600 exam guide">
                                    Download the PL-600 guide
                            ...
                            <div class="work-content">
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        ...
                                        <p>
                                            If you’re looking to prove your expertise as a Microsoft Power Platform or
                                            Microsoft Dynamics 365 solution architect, or if you’re a developer or a
                                            senior consultant ready to take the next step to become a solution
                                            architect, this expert certification can help you move forward in your
                                            career.
                                        </p>
                                        <p>
                                            As a candidate for the Power Platform Solution Architect Expert
                                            certification, you work with stakeholders and focus on solutions that affect
                                            your organization’s broad business and technical needs. You have functional
                                            and technical knowledge of Power Platform, Dynamics 365 customer engagement
                                            apps, related Microsoft cloud solutions, and third-party technologies. For
                                            this certification, you need a minimum of 1 to 3 years as a Power Platform
                                            solution architect or 7 to 10 years as a senior consultant or developer,
                                            along with deep knowledge of Power Platform architecture.
                                        </p>
                                        <p>
                                            If you need additional experience before you try for this certification,
                                            here are some suggestions:
                                        </p>
                                        <ul>
                                            <li>
                                                Work as (or shadow) a solution architect on Power Platform projects
                                            </li>
                                            <li>
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for Power Platform Solution Architect
                            professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            <h2 class="title mb-5">
                                <div class="salary text-white">£<span class="counter">85,000.00</span>+</div>
                            </h2>
                            <small>The average power platform solution architect salary in the United Kingdom is £85,000
                                per year or £43.59 per hour. Entry level positions start at £80,000 per year while most
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    ...
                                                    implementations and focus on how solutions address the broader
                                                    business and technical needs of organizations. This role requires
                                                    the ability to identify opportunities to solve business problems.
                                                </p>
                                                <p>
                                                    Candidates should have functional and technical knowledge of
                                                    Microsoft Power Platform, Dynamics 365 customer engagement apps,
                                                    related Microsoft cloud solutions, and other third-party
                                                    technologies. They apply knowledge and experience throughout an
                                                    engagement. Candidates perform proactive and preventative work to
                                                    increase the value of the customer’s investment and promote
                                                    organizational health.
                                                </p>
                                                <p>
                                                    Candidates should have experience across functional and technical
                                                    disciplines of Microsoft Power Platform. They should be able to
                                                    facilitate design decisions across development, configuration,
                                                    integration, infrastructure, security, licensing, availability,
                                                    storage, and change management. This role balances a project's
                                                    business needs while meeting functional and non-functional
                                                    requirements.
                                                </p>
                                                <ul>
                                                    <li>The English language version of this exam was updated on March
                                                        14, 2022. Please download the exam skills outline below to see
                                                        what changed
                                                    </li>
                                                    <li>Perform solution envisioning and requirement analyses (35-40%)
                                                    </li>
                                                    <li>Architect a solution (40-45%)
                                                    </li>
                                                    <li>Implement the solution (15-20%)</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
