        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li><a href="<?php echo SITE_ADDR ?>/vendor/microsoft/solutions-architect">Solutions Architect</a>
                    </li>
                    <li class="current">Microsoft Certified: Dynamics 365: Finance & Operations Apps Solution Architect
                        Expert</li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-mb-700-microsoft-dynamics-365-finance-and-operations-solution-architect-skills-measured.pdf"
                                    target="_blank" alt="download MB-700 exam guide">
                                    Download the MB-700 guide
                            ...
                            <div class="work-content">
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        ...
                                        <p>
                                            Are you a solution architect, functional or technical consultant, IT
                                            professional, or information worker who is familiar with Microsoft Dynamics
                                            365 apps and Microsoft Power Platform? Do you have a deep understanding of
                                            Dynamics 365 finance and operations apps? Are you a trusted advisor who
                                            understands recommended business practices and software capabilities? If so,
                                            earning this expert certification can open doors that could take your career
                                            to the next level.
                                        </p>
                                        <p>
                                            As a candidate for this certification, you’re a Dynamics 365 professional
                                            who advises stakeholders and translates business requirements into secure,
                                            scalable, and reliable solutions. You design cohesive solutions for your
                                            customers because you know how to work with the essential architectural
                                            components of Dynamics 365 finance and operations apps. You have extensive
                                            domain knowledge in one or more industry verticals. Plus, you understand how
                                            decisions in each area affect the overall solution. In addition, you’re
                                            familiar with platforms, tools, and functional areas, such as finance,
                                            supply chain management, and manufacturing.
                                        </p>
                                        <p>
                                            The Dynamics 365: Finance and Operations Apps Solution Architect Expert
                                            certification is a good fit for you if:
                                        </p>
                                        <ul>
                                            <li>
                                                You have significant experience as a Dynamics 365 finance and operations
                                                apps functional consultant or technical consultant
                                            </li>
                                            <li>
                                                You aspire to be a solution architect or recently started that career
                                                journey
                                            </li>
                                            <li>
                                                You’re responsible for the successful design, implementation,
                                                deployment, and adoption of an overall technology solution in your
                                                organization
                                            </li>
                                            <li>
                                                You have experience consulting with organizations and implementation
                                                team members to refine business needs into well-defined and
                                        ...
                                        <ul>
                                            <li>
                                                Shadow a solution architect or work as one on a few projects
                                            </li>
                                            <li>
                                                Volunteer to design and implement a finance and operations app solution
                                            </li>
                                            <li>
                                                Attend solution architecture workshops with other solution architects
                                            </li>
                                        </ul>
                                        <div class="details-list mb-10">
                                            <label>Prerequisites</label>
                                            <span class="pre-links">
                                                To become a Microsoft Certified: Azure Solutions Architect Expert,
                                                you must earn the following certification first:
                                                <ul>
                                                    <li>
                                                        <a class="text-rb-gradient" target="_blank" href="#" alt="Microsoft Certified: Dynamics 365 Finance Functional
                                                    ...
                                                    <li>
                                                        <a class="text-rb-gradient" target="_blank" href="#" alt="Microsoft Certified: Dynamics 365 Supply Chain Management,
                                                    ...
                                                    <li>
                                                        <a class="text-rb-gradient" target="_blank" href="#" alt="Microsoft Certified: Dynamics 365: Finance and Operations
                                                            Apps Developer Associate">
                                                            Microsoft Certified: Dynamics 365: Finance and Operations
                                                            Apps Developer Associate
                                                        </a>
                                                    </li>
                                                </ul>
                            ...
                            <div class="skill-with-video-content">
                                ...
                                <ul class="agency-list">
                                    <li class="item">
                                        ...
                                        <div class="text">
                                            This list contains the skills measured on the exam associated with this
                                            certification. For information about upcoming or recent changes, see the
                                            associated exam details page and download the exam skills outline
                                        </div>
                                    </li>
                                    <li class="item">
                                        <div class="icon">
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for Solutions Architect
                            professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            <h2 class="title mb-5">
                                <div class="salary text-white">£<span class="counter">70,000.00</span>+</div>
                            </h2>
                            <small>The average solution architect salary in the United Kingdom is £70,000 per year or
                                £35.90 per hour. Entry level positions start at £60,000 per year while most experienced
                                workers make up to £87,458 per year</small>.
                        </div>
                                ...
                                <div class="agency-accordion max-mb-n30" id="accordionExample">
                                    <div class="card">
                                        <div class="card-header" id="headingOne">
                                            <h5 class="mb-0">
                                                <a href="#" class="acc-btn border-0" data-toggle="collapse"
                                                    ...
                                                    Exam MB-700: Microsoft Dynamics 365: Finance and Operations Apps
                                                    Solution Architect
                                                </a>
                                            </h5>
                                        </div>
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    Candidates for this exam are Microsoft Dynamics 365 professionals
                                                    who advise stakeholders and translate business requirements into
                                                    secure, scalable, and reliable solutions.
                                                </p>
                                                <p>
                                                    Candidates should have knowledge of all Dynamics 365 apps and Power
                                                    Platform. They must have deep understanding of Finance and
                                                    Operations apps. In addition, they have extensive domain knowledge
                                                    in one or more industry verticals. This role requires understanding
                                                ...
                                                <ul>
                                                    ...
                                                    <li>Architect solutions (25-30%)</li>
                                                    <li>Define solution strategies (25-30%)</li>
                                                    <li>Manage implementations (25-30%)
                                                    </li>
                                                    <li>Manage testing (10-15%)</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
