...
$title = "Robust IT Training | Microsoft | Solutions Architect | Microsoft Certified: Azure Solutions Architect Expert";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /career/cloud-architect/microsoft-certified-azure-solutions-architect-expert";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">Microsoft Certified: Azure Solutions Architect Expert</h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">Microsoft Certified: Azure Solutions Architect Expert</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-az-305-designing-microsoft-azure-infrastructure-solutions-skills-measured.pdf"
                                    target="_blank" alt="download AZ-305 exam guide">
                                    Download the AZ-305 guide
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <div class="alert alert-danger">
                                            <i class="fa fa-exclamation-circle"></i> <strong>Warning</strong> <br />
                                            Exam AZ-303 and Exam AZ-304 will retire on March 31, 2022. A new exam, Exam
                                            AZ-305, is available.
                                        </div>

                                        <p>
                                            Candidates for the Azure Solutions Architect Expert certification should
                                            have subject matter expertise in designing cloud and hybrid solutions that
                                            run on Microsoft Azure, including compute, network, storage, monitoring, and
                                            security.
                                        </p>
                                        <p>
                                            Responsibilities for this role include advising stakeholders and translating
                                            business requirements into designs for secure, scalable, and reliable Azure
                                            solutions.
                                        </p>
                                        <p>
                                            An Azure solutions architect partners with developers, administrators, and
                                            other roles responsible for implementing solutions on Azure.
                                        </p>
                                        <p>
                                            A candidate for this certification should have advanced experience and
                                            knowledge of IT operations, including networking, virtualization, identity,
                                            security, business continuity, disaster recovery, data platforms, and
                                            governance. A professional in this role should manage how decisions in each
                                            area affect an overall solution. In addition, they should have experience in
                                            Azure administration, Azure development, and DevOps processes
                                        </p>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a class="text-rb-gradient" target="_blank"
                                                            href="<?php echo SITE_ADDR ?>/vendor/microsoft/administrator/microsoft-certified-azure-administration-associate"
                    ...
                    <div class="row align-items-center my-lg-20 my-12">
                        ...
                        <div class="col-xl-5 col-lg-6 col-12" data-aos="fade-up">
                            ...
                            <div class="skill-with-video-content">
                                ...
                                <!-- Agency List End -->
                                <a href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/microsoft-certified-azure-solutions-architect-expert-skills-measured.pdf"
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for Azure Solutions Architect
                            professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            <h2 class="title mb-5">
                                <div class="salary text-white">£<span class="counter">80,000.00</span>+</div>
                            </h2>
                            <small>The average azure solutions architect salary in the United Kingdom is £80,000 per
                                year or £41.03 per hour. Entry level positions start at £70,000 per year while most
                                ...
                                <div class="agency-accordion max-mb-n30" id="accordionExample">
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    Candidates for this exam should have advanced experience and
                                                    ...
                                                    platforms, and governance. A professional in this role should manage
                                                    how decisions in each area affect an overall solution. In addition,
                                                    they should have experience in Azure administration, Azure
                                                    development, and DevOps processes.
                                                </p>
                                                <ul>
                                                    <li>Design identity, governance, and monitoring solutions (25-30%)
                                                    </li>
                                                    <li>Design data storage solutions (25-30%)</li>
                                                    <li>Design business continuity solutions (10-15%)
                                                    </li>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <ul>
                                                    <li>
                                                        The content of this exam was updated on September 24, 2021.
                                                        Please download the exam skills outline below to see what
                                                        changed
                                                    </li>
                                                    <li>Manage Azure identities and governance (15-20%)
                                                    </li>
                                                    <li>Implement and manage storage (15-20%)</li>
                                                    <li>Deploy and manage Azure compute resources (20-25%)
                                                    </li>
