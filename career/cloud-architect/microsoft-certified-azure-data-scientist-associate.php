...
$leadIsFrom = "Lead is from /career/cloud-architect/microsoft-certified-azure-data-scientist-associate";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">Microsoft Certified: Azure Data Scientist Associate
                </h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">Microsoft Certified: Azure Data Scientist Associate</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-dp-100-data-science-solution-on-azure-skills-measured.pdf"
                                    target="_blank" alt="download DP-100 exam guide">
                                    Download the DP-100 guide
                            ...
                            <div class="work-content">
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        ...
                                        <p>
                                            Candidates for the Azure Data Scientist Associate certification should have
                                            subject matter expertise applying data science and machine learning to
                                            implement and run machine learning workloads on Azure.
                                        </p>
                                        <p>
                                            Responsibilities for this role include planning and creating a suitable
                                            working environment for data science workloads on Azure. You run data
                                            experiments and train predictive models. In addition, you manage, optimize,
                                            and deploy machine learning models into production.
                                        </p>
                                        <p>
                                            A candidate for this certification should have knowledge and experience in
                                            data science and using Azure Machine Learning and Azure Databricks.
                                        </p>
                                    </div>
                    ...
                    <div class="row align-items-center my-lg-20 my-12">
                        ...
                        <div class="col-xl-5 col-lg-6 col-12" data-aos="fade-up">
                            ...
                            <div class="skill-with-video-content">
                                ...
                                <!-- Agency List End -->
                                <a href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/microsoft-certified-azure-data-scientist-associate-skills-measured.pdf"
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for Azure Data Scientist
                            professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            ...
                            <small>The average azure data scientist salary in the United Kingdom is £60,000 per year or
                                £30.77 per hour. Entry level positions start at £52,500 per year while most experienced
                                workers make up to £68,875 per year</small>.
                        </div>
                                        ...
                                        <div class="card-header" id="headingOne">
                                            <h5 class="mb-0">
                                                <a href="#" class="acc-btn border-0" data-toggle="collapse"
                                                    ...
                                                    Exam DP-100: Designing and Implementing a Data Science Solution on
                                                    Azure
                                                </a>
                                            </h5>
                                        </div>
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    ...
                                                    applying data science and machine learning to implement and run
                                                    machine learning workloads on Microsoft Azure.
                                                </p>
                                                <p>
                                                    Responsibilities for this role include planning and creating a
                                                    suitable working environment for data science workloads on Azure.
                                                    They run data experiments and train predictive models. In addition,
                                                    they manage, optimize, and deploy machine learning models into
                                                    production.
                                                </p>
                                                <p>
                                                    A candidate for this certification should have knowledge and
                                                    experience in data science and using Azure Machine Learning and
                                                    Azure Databricks.
                                                </p>
                                                <ul>
                                                    <li>The content of this exam was updated on May 20, 2021. Please
                                                        download the exam skills outline below to see what changed
                                                    </li>
                                                    <li>Manage Azure resources for machine learning (25–30%)
                                                    </li>
                                                    <li>Run experiments and train models (20–25%)
                                                    </li>
                                                    <li>Deploy and operationalize machine learning solutions (35–40%)
                                                    </li>
                                                    <li>Implement responsible machine learning (5–10%)</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
