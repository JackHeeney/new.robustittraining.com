...
$title = "Robust IT Training | Microsoft | Microsoft 365 Certified: Security Administrator Associate";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /career/security-analyst/microsoft-365-certified-security-administrator-associate";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">Microsoft 365 Certified: Security Administrator Associate</h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">Microsoft 365 Certified: Security Administrator Associate</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-ms-500-microsoft-365-security-administration-skills-measured.pdf"
                                    target="_blank" alt="download MS-500 exam guide">
                                    Download the MS-500 guide
                                ...
                                <div class="agency-accordion max-mb-n30" id="accordionExample">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    ...
                                                    Microsoft 365 security administrator proactively secures Microsoft
                                                    365 enterprise environments, responds to threats, performs
                                                    investigations, and enforces data governance. The Microsoft 365
                                                    security administrator collaborates with the Microsoft 365
                                                    enterprise administrator, business stakeholders, and other workload
                                                    administrators to plan and implement security strategies and ensures
                                                    that the solutions comply with the policies and regulations of the
                                                    organization.
                                                </p>
                                                <p>
                                                    Candidates for this exam are familiar with Microsoft 365 workloads
                                                    and have strong skills and experience with identity protection,
                                                    information protection, threat protection, security management, and
                                                    data governance. This role focuses on the Microsoft 365 environment
                                                    and includes hybrid environments.
                                                </p>
                                                <ul>
                                                    <li>The English language version of this exam was updated on January
                                                        27, 2022. Please download the exam skills outline below to see
                                                        what changed.</li>
                                                    <li>Implement and manage identity and access (35-40%)
                                                    </li>
                                                    <li>Implement and manage threat protection (25-30%)</li>
                                                    <li>Implement and manage information protection (10-15%)
                                                    </li>
                                                    <li>Manage governance and compliance features in Microsoft 365
                                                        (20-25%)</li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    Candidates for this exam are administrators who deploy, configure,
                                                    secure, manage, and monitor devices and client applications in an
                                                    enterprise environment. Candidates manage identity, access,
                                                    policies, updates, and apps.
                                                </p>
                                                <p>
                                                    As an administrator, candidates typically collaborate with the
                                                    Microsoft 365 enterprise administrator to design and implement a
                                                    device strategy that meets the business needs of a modern
                                                    organization.
                                                </p>
                                                <p>
                                                    Candidates must be familiar with Microsoft 365 workloads and must be
                                                    proficient and experienced in deploying, configuring, and
                                                    maintaining Windows 10 and non-Windows devices and technologies.
                                                </p>
                                                <ul>
                                                    <li>The content of this exam was updated on November 24, 2021.
                                                        Please download the exam skills outline below to see what
                                                        changed.</li>
                                                    <li>Deploy and upgrade operating systems (25-30%)
                                                    </li>
                                                    <li>Manage policies and profiles (20-25%)</li>
                                                    <li>Manage and protect devices (30-35%)
                                                    </li>
                                                    <li>Manage apps and data (10-15%)</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
