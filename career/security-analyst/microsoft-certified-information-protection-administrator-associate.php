...
$title = "Robust IT Training | Microsoft | Security Engineer | Microsoft Certified: Information Protection Administrator Associate";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /career/security-analyst/microsoft-certified-information-protection-administrator-associate";
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-sc-400-microsoft-information-protection-administrator-skills-measured.pdf"
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            <h2 class="title mb-5">
                                <div class="salary text-white">£<span class="counter">44,924.00</span>+</div>
                            </h2>
                            <small>The average information protection salary in the United Kingdom is £44,924 per year
                                or £23.04 per hour. Entry level positions start at £35,000 per year while most
                                ...
                                <div class="col-12 col-xl-6">
                                    ...
                                    <ul class="agency-list">
                                        ...
                                        <li class="item">
                                            ...
                                            <div class="text">
                                                Species Protection / Information Officer
                                            </div>
                                        </li>
