...
$title = "Robust IT Training | Microsoft | Security Engineer | Microsoft Certified: Azure Security Engineer Associate";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /career/security-analyst/microsoft-certified-azure-security-engineer-associate";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">Microsoft Certified: Azure Security Engineer Associate</h1>
        ...
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">Microsoft Certified: Azure Security Engineer Associate</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary"
                                    href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/exam-az-500-microsoft-azure-security-technologies.pdf"
                                    target="_blank" alt="download AZ-500 exam guide">
                                    Download the AZ-500 guide
                                ...
                                <div class="desc mt-8">
                                    <div class="content mb-5" data-aos="fade-up">
                                        <div class="alert alert-primary">
                                            ...
                                            The content of this certification was updated on September 29, 2021. Please
                                            download the skills measured document on the Exam AZ-500 page to see what
                                            changed.
                                        </div>
                                        <p>
                                            Candidates for the Azure Security Engineer Associate certification should
                                            have subject matter expertise in implementing Azure security controls that
                                            protect identity, access, data, applications, and networks in cloud and
                                        ...
                                        <p>
                                            ...
                                            security posture, identifying and remediating vulnerabilities, performing
                                            threat modeling, implementing threat protection, and responding to security
                                            incident escalations.
                                        </p>
                                        <p>
                                            Azure security engineers often serve as part of a larger team to plan and
                                            implement cloud-based management and security.
                                        </p>
                                        <p>
                                            Candidates for this certification should have practical experience in
                                            administration of Azure and hybrid environments. Candidates should have
                                            experience with infrastructure as code, security operations processes, cloud
                                            capabilities, and Azure services.
                                        </p>
                                    </div>
                    ...
                    <div class="row align-items-center my-lg-20 my-12">
                        ...
                        <div class="col-xl-5 col-lg-6 col-12" data-aos="fade-up">
                            ...
                            <div class="skill-with-video-content">
                                ...
                                <!-- Agency List End -->
                                <a href="<?php echo SITE_ADDR ?>/assets/pdf/exam-guides/microsoft/microsoft-certified-azure-security-engineer-associate-skills-measured.pdf"
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff"
                ...
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for Azure Security Engineer
                            professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            ...
                            <small>The average azure security engineer salary in the United Kingdom is £65,000 per year
                                or £33.33 per hour. Entry level positions start at £52,500 per year while most
                                experienced workers make up to £80,000 per year</small>.
                        </div>
                                ...
                                <div class="col-12 col-xl-6">
                                    ...
                                    <ul class="agency-list">
                                        <li class="item">
                                            ...
                                            <div class="text">
                                                Azure Administrator and Security Engineer
                                            </div>
                                        </li>
                                        <li class="item">
                                            <div class="icon">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    ...
                                                    implementing Azure security controls that protect identity, access,
                                                    data, applications, and networks in cloud and hybrid environments as
                                                    part of an end-to-end infrastructure.
                                                </p>
                                                <p>
                                                    Responsibilities for an Azure security engineer include managing the
                                                    security posture, identifying and remediating vulnerabilities,
                                                    performing threat modeling, implementing threat protection, and
                                                    responding to security incident escalations.
                                                </p>
                                                <p>
                                                    Azure security engineers often serve as part of a larger team to
                                                    plan and implement cloud-based management and security.
                                                </p>
                                                <p>
                                                    Candidates for this exam should have practical experience in
                                                    administration of Azure and hybrid environments. Candidates should
                                                    have experience with infrastructure as code, security operations
                                                    processes, cloud capabilities, and Azure services.
                                                </p>
                                                <ul>
                                                    <li>The content of this exam was updated on September 29, 2021.
                                                        Please download the exam skills outline below to see what
                                                        changed.</li>
                                                    <li>Manage identity and access (30-35%)
                                                    </li>
                                                    <li>Implement platform protection (15-20%)</li>
                                                    <li>Manage security operations (25-30%)</li>
