...
$leadIsFrom = "Lead is from /career/ethical-hacker/computer-hacking-forensic-investigator";
                        ...
                        <div class="col-xl-5 col-lg-6 col-12" data-aos="fade-up">
                            ...
                            <div class="skill-with-video-content">
                                ...
                                <div class="section-title-two mb-5">
                                    ...
                                    <span class="sub-title">How You Will Benefit from CHFI</span>
                                    <h2 class="title mb-5">
                                        Why use CHFI?
                                    </h2>
                                    <p>
                                        A BREACH can be BRUTAL. Investing in building an expert in-house forensics
                                        team with CHFI training and certification is a strategic move for enterprises
                                        looking to safeguard their stakeholders’ interests as well as their own. CHFI
                                        empowers their existing team with learning the latest investigation practices.
                                    </p>
                                </div>
                                ...
                                <ul class="agency-list">
                                    ...
                                    <li class="item">
                                        ...
                                        <div class="text">
                                            It is an ANSI 17024 accredited Certification Program, mapped to the NICE 2.0
                                            framework.
                                        </div>
                                    </li>
                                    <li class="item">
                                        ...
                                        <div class="text">
                                            ...
                                            IoT Forensics, Dark Web Forensics, Cloud Forensics (including Azure and
                                            AWS), Network Forensics, Database Forensics, Mobile Forensics, Malware
                                            Forensics (including Emotet and Eternal Blue), OS Forensics, RAM forensics
                                            and Tor Forensics, CHFI v10 covers the latest tools, techniques, and
                                            methodologies along with ample crafted evidence files.
                        ...
                        <div class="col-12 mt-lg-1 mt-20" data-aos="fade-up">
                            ...
                            <div class="faq-content">
                                ...
                                <div class="section-title-two">
                                    ...
                                    <h3 class="title">How CHFI Will Build Your Career</h3>
                                </div>
                                <!-- Section Title Two End -->
                                ...
                                <div class="agency-accordion max-mb-n30" id="accordionExample">
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                CHFI presents a methodological approach to computer forensic including
                                                searching and seizing, chain-of-custody, acquisition, preservation,
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                            data-parent="#accordionExample">
                                            <div class="card-body">
                                                The first certification program to offer  you  Dark Web and IoT
                                                Forensics modules.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                            data-parent="#accordionExample">
                                            <div class="card-body">
                                                Covers latest malware samples like Emotet and Eternal Blue, also known
                                                as WannaCry.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour"
                                            data-parent="#accordionExample">
                                            <div class="card-body">
                                                Master tools and techniques to ensure security across various cloud
                                                platforms — Amazon Web Services, Microsoft Azure Cloud, and Google Cloud
                                                Platform.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseFive" class="collapse" aria-labelledby="headingFive"
                                            data-parent="#accordionExample">
                                            <div class="card-body">
                                                CHFI v10 provides you with 50 GB of crafted evidence files for
                                                investigation purposes which helps to have hands-on experience in
                                                evidence collection.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseSix" class="collapse" aria-labelledby="headingSix"
                                            data-parent="#accordionExample">
                                            <div class="card-body">
                                                The only program that provides thorough learning with a simulated
                                                environment with 50+ complex labs to ensure you obtain must have skills
                                                for your next job.
                                            </div>
                                        </div>
                                    </div>
