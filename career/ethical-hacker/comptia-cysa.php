...
$title = "Robust IT Training | CompTIA | CySA+";
$meta['keywords'] = "";
$meta['description'] = "";
...
$leadIsFrom = "Lead is from /comptia/comptia-cysa";
...
<div id="page work-details" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7" data-bg-image="<?php echo SITE_ADDR ?>/assets/images/bg/bg-certified-ethical-hacker.jpg">
        <div class="page-title">
            <div class="container">
                <h1 class="title">CompTIA CySA+</h1>
                    ...
                    <div class="work-left work-details" data-aos="fade-up">
                        <div class="portfolio-main-info">
                            ...
                            <div class="work-details-course-logo">
                                <img src="<?php echo SITE_ADDR ?>/assets/images/logo/comptia/logocysaplus-01.svg" alt="CompTIA Network+ logo" class="w-100">
                            </div>
                            <!-- Start Details List -->
                            <div class="work-details-list my-10">
                                <div class="details-list">
                                    <label>Exam Prefix</label>
                                    <span>PT0-001 & PT0-002</span>
                                </div>
                                ...
                                <div class="details-list">
                                    ...
                                    <span>Network+, Security+ or equivalent knowledge. Minimum of 3-4 years of hands-on
                                        information security or related experience. While there is no required
                                        prerequisite, PenTest+ is intended to follow CompTIA Security+ or equivalent
                            ...
                            <div class="work-btn mb-10">
                                <a class="btn btn-outline-secondary btn-hover--secondary" href="https://comptiacdn.azureedge.net/webcontent/docs/default-source/booksamples/pentest_studyguide_pt0-002_samplelesson.pdf?sfvrsn=1d2b15d5_2" target="_blank" alt="download Pentest+ exam guide">
                                ...
                                <div class="desc mt-8">
                                    ...
                                    <div class="content mb-5" data-aos="fade-up">
                                        ...
                                        <p>
                                            ...
                                            within the IT security industry is increasingly important for organizations.
                                        ...
                                        <ul>
                                            <li>Leverage intelligence and threat detection techniques</li>
                                            <li>Analyze and interpret data</li>
                                            <li>Identify and address vulnerabilities</li>
                                            <li>Suggest preventative measures</li>
                                            <li>Effectively respond to and recover from incidents</li>
                                        </ul>
                                        <p>
            ...
            <div class="text-white row my-lg-12 my-10 p-10 pl-2 p-xl-10 pl-xl-10" data-bg-color="#fff" data-bg-image="https://www.expatica.com/app/uploads/sites/10/2014/05/Find-a-job-1-1200x675.jpg" data-overlay="0.9">
                <div class="digital-marketing" data-aos="fade-up">
                    <div class="section-title-two">
                        <span class="sub-title text-white">Average salary for CompTIA CySA+
                            Professionals</span>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="digital-marketing" data-aos="fade-up">
                        <div class="section-title-two mb-8">
                            <h2 class="title mb-5">
                                <div class="salary text-white">£<span class="counter">50,000.00</span>+</div>
                            </h2>
                            <small>The average cybersecurity analyst salary in the United Kingdom is £50,000 per year or
                                £25.64 per hour. Entry level positions start at £40,000 per year while most experienced
                                workers make up to £57,500 per year</small>.
                        </div>
                                ...
                                <div class="agency-accordion max-mb-n30" id="accordionExample">
                                    <div class="card">
                                        <div class="card-header" id="headingOne">
                                            <h5 class="mb-0">
                                                <a href="#" class="acc-btn border-0" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                    How Do I Get My CompTIA PenTest+ Certification?
                                                </a>
                                            </h5>
                                        </div>
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <p>
                                                    You will earn the CompTIA PenTest+ certification by passing one exam
                                                    that includes both multiple-choice and performance-based questions.
                                                    Read on for some advice that can increase your chance to succeed in
                                                    your exam and achieve CompTIA PenTest+ certification status.
                                                </p>
                                                <p>
                                                    In its very basic nature, the CompTIA PenTest+ exam is not that much
                                                    different from any other written test that you may have taken
                                                    to-date. The exam uses various question types to verify your
                                                    knowledge in of the following areas:
                                                </p>
                                                <ul>
                                                    <li>Planning and scoping a penetration test assessment</li>
                                                    <li>Understanding legal and compliance requirements
                                                    </li>
                                                    <li>Performing vulnerability scanning and pen testing</li>
                                                    <li>Analyzing data</li>
                                                    <li>Effectively reporting and communicating results</li>
                                                </ul>
                                                <p>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <p>
                                                    Your CompTIA PenTest+ certification is good for three years from the
                                                    date you pass your certification exam. Through our continuing
                                                    education (CE) program, you can easily renew CompTIA PenTest+ and
                                                    extend it for additional three-year periods. Read on to learn more
                                                    about the certification period and ways how you can renew your
                                                    CompTIA PenTest+ certification.
                                                </p>
                                                <p>
                                                    CompTIA PenTest+ is a member of our group of certifications with
                                                    globally-recognized ISO/ANSI accreditation status. They expire three
                                                    years from the date they are earned and can be renewed through our
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <p>
                                                    CompTIA PenTest+ is a certification for cybersecurity professionals
                                                    tasked with penetration testing and vulnerability assessment and
                                                    management.
                                                </p>
                                                <p>
                                                    CompTIA PenTest+ assesses the most up-to-date penetration testing,
                                                    and vulnerability assessment and management skills necessary to
                                                    determine the resiliency of the network against attacks. CompTIA
                                                    PenTest+ is an intermediate-skills level cybersecurity certification
                                                    that focuses on offensive skills through pen testing and
                                                    vulnerability assessment. Successful candidates will have the
                                                    following skills:
                                                </p>
                                                <ul>
                                                    <li>Plan and scope penetration tests</li>
                                                    <li>Conduct passive reconnaissance</li>
                                                    <li>Perform non-technical tests to gather information/li>
                                                    <li>Conduct active reconnaissance</li>
                                                    <li>Analyze vulnerabilities</li>
                                                    <li>Penetrate networks</li>
                                                    <li>Exploit host-based vulnerabilities</li>
                                                    <li>Test applications</li>
                                                    <li>Complete post-exploit tasks
                                                    </li>
                                                    <li>Analyze and report penetration test results</li>
                                                </ul>
                                                <p>
                                                    The CompTIA PenTest+ exam focuses on today’s best practices to
                                                    communicate recommended strategies to improve the overall state of
                                                    IT security including more emphasis on the practical and hands-on
                                                    ability to perform tasks on systems.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <p>
                                                    The CompTIA PenTest+ exam has no more than 85 questions. After
                                                    completing the exam, you will be asked to fill out some optional
                                                    exit survey information about your study practices and why you
                                                    decided to get certified. This will consist of about 12 multiple
                                                    choice questions.
                                                </p>
                                            </div>
                                        </div>
