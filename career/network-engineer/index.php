...
$title = "Robust IT Training | Search by career | Network Engineer";
$meta['keywords'] = "";
$meta['description'] = "";

// Social media meta tags
$meta['og:title'] = "Robust IT Training | Search by career | Network Engineer";
$meta['og:description'] = "";
$meta['og:image'] = "";
$meta['og:url'] = "";
...
<div id="page" class="section">
    ...
    <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7"
        ...
        <div class="page-title">
            <div class="container">
                <h1 class="title">Network Engineer Courses</h1>
            </div>
        </div>
        <div class="page-breadcrumb position-static">
            <div class="container">
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current">Network Engineer</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="section section-padding-t90-b100">
        <div class="container">
            ...
            <div class="section-title text-center " data-aos="fade-up">
                <h2 class="title fz-32"> View our Network Engineer Courses :</h2>
            </div>
            <!-- Section Title End -->
            ...
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 mb-n6">
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<? echo SITE_ADDR ?>/career/network-engineer/comptia-network"><img
                                    src="<? echo SITE_ADDR ?>/assets/images/project/comptia/network-plus.jpg"
                                    alt="network-plus.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<? echo SITE_ADDR ?>/career/network-engineer/comptia-network">Network+</a>
                            </h3>
                            ...
                            <a href="<? echo SITE_ADDR ?>/career/network-engineer/comptia-network">View
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/career/network-engineer/comptia-server"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/comptia/server-plus.jpg"
                                    alt="server-plus.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<?php echo SITE_ADDR ?>/career/network-engineer/comptia-server">Server+</a>
                            </h3>
                            ...
                            <a href="<?php echo SITE_ADDR ?>/career/network-engineer/comptia-server">View
                                Course <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/career/ethical-hackercomptia-casp"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/comptia/casp-plus.jpg"
                                    alt="casp-plus.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<?php echo SITE_ADDR ?>/career/ethical-hackercomptia-casp">CASP+</a>
                            </h3>
                            ...
                            <a href="<?php echo SITE_ADDR ?>/career/ethical-hackercomptia-casp">View
                                Course <i class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image"
                                href="<? echo SITE_ADDR ?>/career/ethical-hacker/certified-network-defender"
                                alt="link to Certified Network Defender"><img
                                    src="<? echo SITE_ADDR ?>/assets/images/project/ec-council/cnd.jpg" alt="CND"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a
                                    href="<? echo SITE_ADDR ?>/career/ethical-hacker/certified-network-defender"
                                    alt="link to Certified Network Defender">Certified
                            ...
                            <a href="<? echo SITE_ADDR ?>/career/ethical-hacker/certified-network-defender"
                                alt="link to Certified Network Defender">View Course <i
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/career/ethical-hacker/ccna"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/cisco/ccna.jpg"
                                    alt="ccna.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a href="<?php echo SITE_ADDR ?>/career/ethical-hacker/ccna">CCNA</a></h3>
                            ...
                            <a href="<?php echo SITE_ADDR ?>/career/ethical-hacker/ccna">View Course
                ...
                <div class="col mb-6">
                    <div class="work single-portfolio">
                        <div class="thumbnail">
                            <a class="image" href="<?php echo SITE_ADDR ?>/career/ethical-hacker/ccnp-security"
                                alt="link to ccnp security"><img
                                    src="<?php echo SITE_ADDR ?>/assets/images/project/cisco/ccnp.jpg"
                                    alt="ccnp.jpg"></a>
                        </div>
                        <div class="info">
                            <h3 class="title"><a href="<?php echo SITE_ADDR ?>/career/ethical-hacker/ccnp-security"
                            ...
                            <a href="<?php echo SITE_ADDR ?>/career/ethical-hacker/ccnp-security"
