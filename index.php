...
<div id="page" class="section">
    ...
    <div class="section section-padding-t90 section-padding-bottom-200" id="scroll-to-one"
        style="scroll-margin-top: 3em" data-bg-color="#f8faff">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-7 col-lg-6 col-12" data-aos="fade-up" data-aos-delay="400">
                    <div class="about-image-area">
                        <div class="about-image js-tilt">
                            <img src="assets/images/about/home-one-about/class-to-career-2.jpg" alt="">
                        </div>
                        <div class="about-image js-tilt">
                            <img src="assets/images/about/home-one-about/class-to-career-1.jpg" alt="">
                        </div>
                ...
                <div class="col-xl-5 col-lg-6 col-12 section-padding-t100" data-aos="fade-up" data-aos-delay="600">
                    ...
                    <a class="btn btn-primary btn-hover-secondary mt-xl-8 mt-lg-8 mt-md-6 mt-4"
                        href="#choose-learning-path">
    ...
    <div class="section mt-xl-25 py-xl-25 py-50" data-bg-color="#fff">
        ...
        <div class="container text-center icon-up-down-animation">
            <span id="choose-learning-path" style="scroll-margin-top: 17em"></span>
            ...
            <div class="shape shape-1" data-aos="fade-zoom-in" data-aos-delay="800">
                <span>
                    <a href="<?php echo SITE_ADDR ?>/vendor/comptia" alt="">
            ...
            <div class="shape shape-2" data-aos="fade-zoom-in" data-aos-delay="1400">
                <span>
                    <a href="<?php echo SITE_ADDR ?>/vendor/microsoft/azure" alt="">
            ...
            <div class="shape shape-3" data-aos="fade-zoom-in" data-aos-delay="400">
                <span>
                    <a href="<?php echo SITE_ADDR ?>/vendor/microsoft" alt="">
            ...
            <div class="shape shape-4" data-aos="fade-zoom-in" data-aos-delay="600">
                <span>
                    <a href="<?php echo SITE_ADDR ?>/vendor/aws" alt="">
            ...
            <!-- <div class="shape shape-5" data-aos="fade-zoom-in" data-aos-delay="600">
                <span>
                    <a href="<?php echo SITE_ADDR ?>/vendor/google" alt="">
            ...
            <div class="shape shape-6" data-aos="fade-zoom-in" data-aos-delay="1000">
                <span>
                    <a href="<?php echo SITE_ADDR ?>/vendor/ec-council" alt="ec-council learning paths">
            ...
            <div class="shape shape-7" data-aos="fade-zoom-in" data-aos-delay="1200">
                <span>
                    <a href="<?php echo SITE_ADDR ?>/vendor/cisco" alt="">
    ...
    <div class="section my-xl-25 py-25" data-bg-color="#f8faff">
        <div class="container">
            ...
            <div class="section-title text-center mb-12" data-aos="fade-up">
                ...
                <p class="sub-title">We offer online and classroom solutions, industry respected tutors, recruitment
                    help etc etc.</p>
            </div>
            <!-- Section Title End -->

            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 mb-n6" data-aos="fade-up">

                <!-- Icon Box Start -->
                <div class="col mb-6">

                    <div class="icon-box text-center"
                        data-bg-image="<?php echo SITE_ADDR ?>/assets/images/services/corporate.jpg" data-vivus-hover
                        data-overlay="0.8">
                        ...
                        <div class="content">
                            ...
                            <a href="<?php echo SITE_ADDR ?>/corporate-enquiries" class="link">Learn More <i
                                    class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                ...
                <div class="col mb-6">
                    ...
                    <div class="icon-box text-center"
                        data-bg-image="<?php echo SITE_ADDR ?>/assets/images/services/elcas.jpg" data-vivus-hover
                        data-overlay="0.8">
                        <div class="icon"><img class="svgInject"
                        ...
                        <div class="content">
                            ...
                            <a href="<?php echo SITE_ADDR ?>/elcas-enquiries" class="link">Learn More <i
                                    class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
                ...
                <div class="col mb-6">
                    ...
                    <div class="icon-box text-center"
                        ...
                        data-vivus-hover data-overlay="0.8">
                        <div class="icon"><img class="svgInject"
                        ...
                        <div class="content">
                            ...
                            <a href="<?php echo SITE_ADDR ?>/career-advice" class="link">Learn More <i
                                    class="fas fa-chevron-right fcr-animate"></i></a>
                        </div>
                    </div>
...
<div class="section section-padding ag-masonary-wrapper" data-bg-color="#fff">
    <div class="container">
        ...
        <div class="row align-items-center" data-aos="fade-up" data-aos-offset="-400">
            <div class="col-lg-5">
                <!-- Section Title Two Start -->
        ...
        <div class="row row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 g-0 mesonry-list" data-aos="fade-up"
            data-aos-offset="-560">
...
<!-- Faq Section Start -->
<div class="faq-section section py-20" data-bg-color="#f8faff">
    <div class="container">

        <div class="row mb-10" data-aos="fade-up" data-aos-offset="-400">
            <div class="col-12">
        ...
        <div class="row row-cols-lg-1 row-cols-1" data-aos="fade-up" data-aos="fade-up" data-aos-offset="-500">
...
<div class="section section-padding contact-section" data-bg-color="#fff" data-overlay="0">
    ...
    <div class="container">
        <div class="row row-cols-lg-2 row-cols-1 align-items-center">
            ...
            <div class="col mt-lg-0 mt-md-10 mt-8" data-aos="fade-up" data-aos-offset="-200">
